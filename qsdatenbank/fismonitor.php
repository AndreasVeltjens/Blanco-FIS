...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst611401 = "SELECT * FROM `user` where rst611402=1 ORDER BY `user`.id";
$rst611401 = mysql_query($query_rst611401, $qsdatenbank) or die(mysql_error());
$row_rst611401 = mysql_fetch_assoc($rst611401);
$totalRows_rst611401 = mysql_num_rows($rst611401);

mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst611402 = "SELECT * FROM `user` where rst611402=1 ORDER BY `user`.id";
$rst611402 = mysql_query($query_rst611402, $qsdatenbank) or die(mysql_error());
$row_rst611402 = mysql_fetch_assoc($rst611402);
$totalRows_rst611402 = mysql_num_rows($rst611402);

mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst611403 = "SELECT * FROM `user` where rst611403=1 ORDER BY `user`.id";
$rst611403 = mysql_query($query_rst611403, $qsdatenbank) or die(mysql_error());
$row_rst611403 = mysql_fetch_assoc($rst611403);
$totalRows_rst611403 = mysql_num_rows($rst611403);

mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst611404 = "SELECT * FROM `user` where rst611404=1 ORDER BY `user`.id";
$rst611404 = mysql_query($query_rst611404, $qsdatenbank) or die(mysql_error());
$row_rst611404 = mysql_fetch_assoc($rst611404);
$totalRows_rst611404 = mysql_num_rows($rst611404);

mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst611405 = "SELECT * FROM `user` where rst611405=1 ORDER BY `user`.id";
$rst611405 = mysql_query($query_rst611405, $qsdatenbank) or die(mysql_error());
$row_rst611405 = mysql_fetch_assoc($rst611405);
$totalRows_rst611405 = mysql_num_rows($rst611405);

mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst611406 = "SELECT * FROM `user` where rst611406=1 ORDER BY `user`.id";
$rst611406 = mysql_query($query_rst611406, $qsdatenbank) or die(mysql_error());
$row_rst611406 = mysql_fetch_assoc($rst611406);
$totalRows_rst611406 = mysql_num_rows($rst611406);

mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst611407 = "SELECT * FROM `user` WHERE rst611407=1 ORDER BY `user`.id";
$rst611407 = mysql_query($query_rst611407, $qsdatenbank) or die(mysql_error());
$row_rst611407 = mysql_fetch_assoc($rst611407);
$totalRows_rst611407 = mysql_num_rows($rst611407);

mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst611408 = "SELECT * FROM `user` WHERE rst611408=1 ORDER BY `user`.id";
$rst611408 = mysql_query($query_rst611408, $qsdatenbank) or die(mysql_error());
$row_rst611408 = mysql_fetch_assoc($rst611408);
$totalRows_rst611408 = mysql_num_rows($rst611408);

mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst611301 = "SELECT * FROM `user` where rst611301=1 ORDER BY `user`.id";
$rst611301 = mysql_query($query_rst611301, $qsdatenbank) or die(mysql_error());
$row_rst611301 = mysql_fetch_assoc($rst611301);
$totalRows_rst611301 = mysql_num_rows($rst611301);

mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst611101 = "SELECT * FROM `user` where rst611101=1 ORDER BY `user`.id";
$rst611101 = mysql_query($query_rst611101, $qsdatenbank) or die(mysql_error());
$row_rst611101 = mysql_fetch_assoc($rst611101);
$totalRows_rst611101 = mysql_num_rows($rst611101);
...
$d=intval($i/2);
  ...
  ?>
	...
	<td colspan="4">
      ...
      <td colspan="4"><?php include('fismonitor.tmp1.php'); ?>
	  
	<?php include('fismonitor.tmp2.php'); ?>
    </tr>
    <tr> 
      <td colspan="2"><em><strong>allgemeine Aktionen w&auml;hlen:</strong></em></td>
      <td width="58"><img src="picture/author.gif" width="15" height="20">INVENTUR 
        2009</td>
      <td width="275"> <p><a href="../documents/inventur/" target="_blank"><img src="picture/rules.gif" width="13" height="18" border="0" align="absmiddle"> 
          Zwischen-Inventur-Z&auml;hlliste</a><a href="pdfetikett6.php?url_artikelid=1&url_bezeichnung=<?php echo $row_rst4['Bezeichnung']; ?>&url_artikelnummer=<?php echo $row_rst4['Nummer'] ?>&url_sn_ab=<?php echo $url_sn_von ?>&url_sn_bis=<?php echo $url_sn_bis ?>" target="_blank"><br>
          <img src="picture/rules.gif" width="13" height="18" border="0" align="absmiddle"> 
          Aufkleber drucken</a><br>
          <a href="../documents/inventur/"><img src="picture/rules.gif" width="13" height="18" border="0" align="absmiddle"> 
          Inventuranweisung &ouml;ffnen</a> </p></td>
    </tr>
    <tr bgcolor="#CCCCFF"> 
...
mysql_free_result($rst611406);

mysql_free_result($rst611407);
?>
<p>&nbsp;</p>
<p>&nbsp;</p>
