...
if (!isset($HTTP_POST_VARS["datum1"])){$HTTP_POST_VARS["datum1"]=0;}
if ($HTTP_POST_VARS["datum1"]==0){
$suchkrit1="";}else{
$suchkrit1=" and fehlermeldungen.fm1datum >='$HTTP_POST_VARS[datum1]' ";
} 
if (!isset($HTTP_POST_VARS["datum2"])){$HTTP_POST_VARS["datum2"]=0;}
if ($HTTP_POST_VARS["datum2"]==0){
$suchkrit2="";}else{
$suchkrit2=" and fehlermeldungen.fm1datum <='$HTTP_POST_VARS[datum2]' ";
} 
...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="728" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="196"> <img src="picture/b_drop.png" width="16" height="16"> <input name="cancel" type="submit" id="cancel2" value="Zur&uuml;ck"></td>
    ...
    <tr> 
      ...
      <td> <select name="artikelid" id="select">
...
?>
      ...
      <td><div align="right">ab Datum 
          <input name="datum1" type="text" id="datum1" value="<?php echo $HTTP_POST_VARS['datum1'];?>" size="12" maxlength="12">
          <script type="text/javascript">
                    <!--
                    document.write('<a title="<?php echo $strCalendar;?>" href="javascript:openCalendar(\'<?php echo $editFormAction;?>\', \'form2\', \'datum1\', \'date\')"><img class="calendar" src="<?php echo $pmaThemeImage; ?>./picture/b_calendar.png" alt="<?php echo $strCalendar; ?>"/></a>');
                    //-->
                    </script>
          bis 
          <input name="datum2" type="text" id="datum2" value="<?php echo $HTTP_POST_VARS['datum2'];?>" size="12" maxlength="12">
          <script type="text/javascript">
                    <!--
                    document.write('<a title="<?php echo $strCalendar;?>" href="javascript:openCalendar(\'<?php echo $editFormAction;?>\', \'form2\', \'datum2\', \'date\')"><img class="calendar" src="<?php echo $pmaThemeImage; ?>./picture/b_calendar.png" alt="<?php echo $strCalendar; ?>"/></a>');
                    //-->
                    </script>
  ...
  ausw&auml;hlen oder Datumsreihenfolge pr&uuml;fen. </font></strong> <strong><font color="#FF0000"></font></strong> 
...
<p><img src="la58.tmp1.php?artikelid=<?php echo $HTTP_POST_VARS['artikelid']; ?>&datum1=<?php echo $HTTP_POST_VARS['datum1'] ?>&datum2=<?php echo $HTTP_POST_VARS['datum2'] ?>"> 
</p>
<br>
<br>
<img src="la59.tmp3.php?artikelid=<?php echo $HTTP_POST_VARS['artikelid']; ?>&datum1=<?php echo $HTTP_POST_VARS['datum1'] ?>&datum2=<?php echo $HTTP_POST_VARS['datum2'] ?>"> 
<br>
<br>
<table width="730" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="46" bgcolor="#FFFFCC">Fehler</td>
    <td width="684"> <table width="682" border="0" cellspacing="1" cellpadding="1">
		...
		$datax[$i-1]=substr($row_rst2['fname'],0,50);
		?>
        <tr <?php if ($i/$d==2) {echo "bgcolor=\"#CCCCFF\"";}?>> 
          <td width="133"><?php echo $row_rst2['fname']; ?></td>
