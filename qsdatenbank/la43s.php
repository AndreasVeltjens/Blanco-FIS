...
<table width="883" border="0" cellpadding="0" cellspacing="1">
  ...
  <form name="form1" method="post" action="">
    <tr onMouseOver="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onMouseOut="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onMouseDown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
	  ...
	  <a href="la43.php?url_user=<?php echo $row_rst1['id']; ?>&url_fmid=<?php echo $row_rst2['fmid']; ?>"><img src="picture/b_edit.png" alt="bearbeiten" width="16" height="16" border="0"></a>
	  <?php }else{?>
	  <a href="la43.php?url_user=<?php echo $row_rst1['id']; ?>&url_fmid=<?php echo $row_rst2['fmid']; ?>"><img src="picture/fertig.gif" alt="anzeigen" width="16" height="16" border="0" target="_blank"></a>
	  <?php }?>
...
?>
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1" face="Arial, Helvetica, sans-serif"><?php echo $row_rst2['fm1datum']; ?><a href="pdfkv1.php?url_fmid=<?php echo $row_rst2['fmid']; ?>&url_user_id=<?php echo $row_rst1['id'];?>%20" target="_blank"><img src="picture/ico_anruflisten.gif" alt="Kostenvoranschlag" width="16" height="16" border="0"></a></font></td>
...
<p>&nbsp;Statistik: <?php echo $totalRows_rst2 ?> Retouren zur Freigabe angelegt.</p>
<p> 
  <?php
