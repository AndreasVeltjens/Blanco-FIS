...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="728" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="370"> <div align="right"><font size="5"><strong>Kontrollmodus 
          alle Retouren</strong></font> 
...
?>
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><div align="right"> 
          <font size="1" face="Arial, Helvetica, sans-serif"> 
          <input <?php if (!(strcmp($row_rst2['fm1b'],1))) {echo "checked";} ?> name="fm1b" type="checkbox" id="fm1b" value="fm1b">
          <input name="fm1text" type="text" id="fm1text" value="<?php echo $row_rst2['fm1text']; ?>">
