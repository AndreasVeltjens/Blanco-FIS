...
WHERE auslieferungen.typ = 1 AND artikeldaten.Nummer=auslieferungen.nummer AND auslieferungen.lokz=0 ORDER BY  artikeldaten.Gruppe asc , artikeldaten.bezeichnung asc";
