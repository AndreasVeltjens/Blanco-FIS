...
if ($totalRows_rst2>0){
		...
		case 14 :
			$pdf->MultiCell(160,5,utf8_decode(utf8_encode("Monsieur,\n\nSuite à notre entretien téléphonique, veuillez trouver ci joint en prêt:")),0,"","");
		break;
		}
 ...
 $pdf->Ln(4);		
		...
		$pdf->Write(13, 'numéro de série     : '.urldecode($row_rst5['sn']));
		$pdf->Ln(4);
...
/* Lieferadresse begin 
	...
	/* 	$pdf->Ln(1);
		...
		switch ($row_rst3['id_fhmea']) {
		case 14 :
			$pdf->MultiCell(160,5,utf8_decode(utf8_encode(wordwrap("Après la réparation et livraison de votre porte, un transporteur sera commissionné pour la reprise du matériel de prêt.ous vous remercions de prendre soin de la porte en prêt, car dans le cas d'un endommagement nous nous verrons dans l'obligation de vous facturer la réparation. Nous vous souhaitons bonne réception de la présente et restons à votre entière disposition pour tout renseignement complémentaire.\n\nVeuillez agréer, Monsieur, l'expression de nos salutations distinguées.",100,"\n",255) )),0,"","");
		break;
		case 15 :
			$pdf->MultiCell(160,5,utf8_decode(utf8_encode(wordwrap("Après la réparation et livraison de votre porte, un transporteur sera commissionné pour la reprise du matériel de prêt.ous vous remercions de prendre soin de la porte en prêt, car dans le cas d'un endommagement nous nous verrons dans l'obligation de vous facturer la réparation. Nous vous souhaitons bonne réception de la présente et restons à votre entière disposition pour tout renseignement complémentaire.\n\nVeuillez agréer, Monsieur, l'expression de nos salutations distinguées.",100,"\n",255) )),0,"","");
		break;
