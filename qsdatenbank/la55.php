...
do {  
?>
          <option value="<?php echo $row_rst3['Gruppe']?>"<?php if (!(strcmp($row_rst3['Gruppe'], $HTTP_POST_VARS['gruppe']))) {echo "SELECTED";} ?>><?php echo $row_rst3['Gruppe']?></option>
          <?php
