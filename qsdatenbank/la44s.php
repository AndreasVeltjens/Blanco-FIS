...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT fehlermeldungen.fmid, fehlermeldungen.fmsn,fehlermeldungen.fmdatum, fehlermeldungen.fm3datum,  fehlermeldungen.fmartikelid, fehlermeldungen.fmfd, fehlermeldungen.fm1, fehlermeldungen.fm2, fehlermeldungen.fm3, fehlermeldungen.fm4, fehlermeldungen.fm5, fehlermeldungen.fm0, fehlermeldungen.fm6, fehlermeldungen.fm6, fehlermeldungen.fm1notes, fehlermeldungen.fm11notes, fehlermeldungen.fm12notes, fehlermeldungen.sappcna, fehlermeldungen.fm1datum, fehlermeldungen.fm2variante, fehlermeldungen.vip, fehlermeldungen.vkz FROM fehlermeldungen  $suchtext ORDER BY fehlermeldungen.fm3datum ASC";
...
$updateGoTo = "la44.php?url_user=".$row_rst1['id']."&url_fmid=".$HTTP_POST_VARS["hurl_fmid"]."&goback=la44s.php";
  header(sprintf("Location: %s", $updateGoTo));
}else{$errtxt = "Aktion wählen. Bitte erneut versuchen.";}
...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="950" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="370"> <div align="right"><img src="picture/st2.gif" width="15" height="15"> 
...
<p>&nbsp;Statistik: <?php echo $totalRows_rst2 ?> Retouren zur Reparatur und VDE-Pr&uuml;fung angelegt.</p>
...
<table width="730" border="0" cellpadding="0" cellspacing="1">
  ...
  <form name="form1" method="post" action="">
    <tr onMouseOver="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onMouseOut="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onMouseDown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
	  ...
	  <a href="la44.php?url_user=<?php echo $row_rst1['id']; ?>&url_fmid=<?php echo $row_rst2['fmid']; ?>"><img src="picture/b_edit.png" alt="bearbeiten" width="16" height="16" border="0"></a>
	  <?php }else{?>
	  <a href="la44.php?url_user=<?php echo $row_rst1['id']; ?>&url_fmid=<?php echo $row_rst2['fmid']; ?>"><img src="picture/fertig.gif" alt="anzeigen" width="16" height="16" border="0" target="_blank"></a>
	  <?php }?>
	  </font></td>
...
do {  
?>
        <?php if (!(strcmp($row_rsttyp['artikelid'], $row_rst2['fmartikelid']))) {echo substr($row_rsttyp['Bezeichnung'],0,25);} ?>
        <?php
...
?>
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1" face="Arial, Helvetica, sans-serif"><?php echo $row_rst2['fm3datum']; ?></font> <a href="pdfetikett1.php?url_fmid=<?php echo $row_rst2['fmid']; ?>" target="_blank"><img src="picture/icon_info.gif" alt="Etikett drucken" width="14" height="14" border="0"></a> 
        <a href="pdfversandetikettGLS.php?url_fmid=<?php echo $row_rst2['fmid']; ?>" target="_blank"><img src="picture/anschreiben.gif" alt="Versandetikett für GLS drucken" width="14" height="14" border="0"></a> 
		 <a href="pdfkv1.php?url_fmid=<?php echo $row_rst2['fmid']; ?>&url_user_id=<?php echo $row_rst1['id'];?>%20" target="_blank"><img src="picture/ico_anruflisten.gif" alt="Kostenvoranschlag" width="16" height="16" border="0"></a>
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"> 
          ...
          <img src="picture/<?php if ($row_rst2['sappcna']>1) {echo "st1.gif";}else{ echo "st3.gif";
		  
		  }?>" alt="SAP Fertigungsauftr&auml;ge als PCNA angelegt" width="15" height="15"> 
          <?php }?>
          </font></div></td>
      <td    bgcolor="#EEEEcc" nowrap="nowrap"> <div align="center"> <font size="1" face="Arial, Helvetica, sans-serif"> 
          <?php if  ($row_rst2['vkz']==1){ echo "<img src=\"picture/b_drop.png\" "; }else{ ?>
