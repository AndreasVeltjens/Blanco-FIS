...
$updateGoTo = "kundenstart.php?url_user=".$row_rst1['id']."&url_kundenummer=".$HTTP_POST_VARS["url_kundenummer"];
  if (isset($HTTP_SERVER_VARS['QUERY_STRING'])) {
  ...
  <table width="728" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="332"> <div align="right"> 
          ...
          <input name="new" type="submit" id="new" value="neue Retourenabwicklung anlegen">
        </div></td>
    </tr>
...
do {  
?>
        <?php if (!(strcmp($row_rsttyp['artikelid'], $row_rst2['fmartikelid']))) {echo htmlentities($row_rsttyp['Bezeichnung']);} ?>
        <?php
