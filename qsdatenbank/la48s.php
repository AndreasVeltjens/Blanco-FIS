...
$updateGoTo = "la48.php?url_user=".$row_rst1['id']."&url_fmid=".$HTTP_POST_VARS["hurl_fmid"]."&goback=la48s.php";
  header(sprintf("Location: %s", $updateGoTo));
}else{$errtxt = "Aktion wählen. Bitte erneut versuchen.";}
...
<table width="996" border="0" cellpadding="0" cellspacing="1">
  <tr> 
    <td width="25">VIP</td>
    ...
    <td width="16"><img src="picture/iconBestOffer_16x16.gif" width="16" height="16"></td>
    <td width="112">&nbsp;</td>
  </tr>
  <?php do { ?>
