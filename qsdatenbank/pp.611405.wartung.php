...
if (isset($materialnummer2) or $materialnummer2==1){ $warengruppe="BLT Heizmodul"; }
...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst_material = "SELECT * FROM artikeldaten WHERE artikeldaten.aktiviert=1 and artikeldaten.Kontierung like '%halb%' and ( artikeldaten.Gruppe like '$warengruppe' $abfrage ) ORDER BY artikeldaten.Gruppe, artikeldaten.Bezeichnung ";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#CCCCCC"> 
    ...
    <td width="270"><img src="picture/arrowClose.gif" width="8" height="9"> Kennzahlen</td>
    <td width="297">&nbsp;</td>
...
?>
    ...
    <td colspan="3">
    <img src="la56.tmp2.php?artikelid=<?php echo $HTTP_POST_VARS['artikelid']; ?>&datum1=<?php echo $HTTP_POST_VARS['datum1'] ?>&datum2=<?php echo $HTTP_POST_VARS['datum2'] ?>&location=<?php echo $location ?>"> 
	
	<img src="la56.tmp1.php?artikelid=<?php echo $HTTP_POST_VARS['artikelid']; ?>&datum1=<?php echo $HTTP_POST_VARS['datum1'] ?>&datum2=<?php echo $HTTP_POST_VARS['datum2'] ?>&location=<?php echo $location ?>"> 
