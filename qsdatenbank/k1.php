...
if (isset($HTTP_POST_VARS['suchtext']) and ($HTTP_POST_VARS['url_suchtext']!=="")){
	$url_such=" AND ( zeichnungen.zeichnungsnummer like '%".$HTTP_POST_VARS['url_suchtext']."' OR zeichnungen.beschreibung like '%".$HTTP_POST_VARS['url_suchtext']."%' ) ";
		}else {
	$url_such="";
	}
...
if ((isset($HTTP_POST_VARS["ablage"])) ) {
$updateGoTo = "k2.php?url_user=".$row_rst1['id'];
  if (isset($HTTP_SERVER_VARS['QUERY_STRING'])) {
...
$updateGoTo = "k15.php?url_user=".$row_rst1['id'];
  if (isset($HTTP_SERVER_VARS['QUERY_STRING'])) {
    $updateGoTo .= (strpos($updateGoTo, '?')) ? "&" : "?";
    $updateGoTo .= $HTTP_SERVER_VARS['QUERY_STRING'];
  }
...
$updateGoTo = "k12.php?url_user=".$row_rst1['id']."&url_id_zeichnung=".$HTTP_POST_VARS["hurl_id_zeichnung"]."&url_suchtext=".$HTTP_POST_VARS["url_suchtext"]."&url_ablage=".$HTTP_POST_VARS["url_id_ablage"];
  header(sprintf("Location: %s", $updateGoTo));
}else{$errtxt = "Aktion wählen. Bitte erneut versuchen.";}

if ((isset($HTTP_POST_VARS["new"])) ) {
$updateGoTo = "k11.php?url_user=".$row_rst1['id'];
  header(sprintf("Location: %s", $updateGoTo));
}else{$errtxt = "Aktion wählen. Bitte erneut versuchen.";}
...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="762" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="504"> <div align="right">
          <input name="print" type="submit" id="print" value="Inhaltsverzeichnis drucken">
          <input name="ablage" type="submit" id="ablage" value="Ablagen verwalten">
          <input name="hurl_user" type="hidden" id="hurl_user" value="<?php echo $row_rst1['id']; ?>">
          <img src="picture/b_newdb.png" width="16" height="16"> 
          <input name="new" type="submit" id="new" value="neue Zeichnung verteilen">
        </div></td>
    </tr>
    <tr> 
...
<table width="762" border="0" cellpadding="0" cellspacing="0">
  ...
  <form name="form1" method="post" action="">
    <tr onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<img src="picture/att.gif" alt="Dokument-ID" width="12" height="18" border="0" align="absmiddle"><?php echo $row_rst2['id_zeichnung']; ?></font></td>
