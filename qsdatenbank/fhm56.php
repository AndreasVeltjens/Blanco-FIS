...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT date_format(fhm_ereignis.datum,\"%Y %M\") as fehlerdatum, count(fhm_ereignis.id_fhme) as anzahl, fhm_ereignisart.wert FROM fhm, fhm_ereignis, fhm_gruppe, fhm_ereignisart WHERE fhm.id_fhm=fhm_ereignis.id_fhm and fhm_gruppe.id_fhm_gruppe=fhm.id_fhm_gruppe $gruppe  and fhm_ereignis.id_fhmea=fhm_ereignisart.id_fhmea AND fhm_ereignis.lokz =0 and fhm_ereignisart.wert = 1 GROUP BY date_format(fhm_ereignis.datum,\"%Y %M\") ORDER BY fhm_ereignis.datum desc limit 0,200";
...
?>
    ...
    <tr>
      <td>gemeldete St&ouml;rungen</td>
      <td>&nbsp;</td>
...
<p><img src="fhm56.tmp1.php?gruppe=<?php echo $HTTP_POST_VARS['gruppe']; ?>"> 
</p>
<br>
<br>
<br>
