...
if ((isset($HTTP_POST_VARS['delete']))) {
  $deleteSQL = sprintf("DELETE FROM qmbmitteilungen WHERE id_mitt=%s",
...
if ((isset($HTTP_POST_VARS["add"]))) {
  $insertSQL = sprintf("INSERT INTO qmbmitteilungen (name, datum, Zeit, vorlauf, werk, `user`) VALUES (%s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_nachrichten, $nachrichten);
$query_rst2 = "SELECT * FROM qmbmitteilungen ORDER BY qmbmitteilungen.datum desc";
$rst2 = mysql_query($query_rst2, $nachrichten) or die(mysql_error());
$row_rst2 = mysql_fetch_assoc($rst2);
$totalRows_rst2 = mysql_num_rows($rst2);

if ((isset($HTTP_POST_VARS["Retourenabwicklung"])) ) {
...
$updateGoTo = "qmb12.php?url_user=".$row_rst1['id']."&url_id_mitt=".$HTTP_POST_VARS["hmitt"];
...
<form name="form3" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="730" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#CCCCFF" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
      ...
      <td nowrap="nowrap"><textarea name="name" cols="60" rows="3" id="name"></textarea> 
      </td>
