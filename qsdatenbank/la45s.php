...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT fehlermeldungen.fmid, fehlermeldungen.lort, fehlermeldungen.rort, fehlermeldungen.fmsn, fehlermeldungen.fm1datum,fehlermeldungen.fmdatum, fehlermeldungen.fmartikelid, fehlermeldungen.fmfd, fehlermeldungen.fm1, fehlermeldungen.fm2, fehlermeldungen.fm3, fehlermeldungen.fm4, fehlermeldungen.fm5, fehlermeldungen.fm0, fehlermeldungen.fm6, fehlermeldungen.fm6, fehlermeldungen.fm1notes, fehlermeldungen.sappcna, fehlermeldungen.vkz FROM fehlermeldungen $suchtext ORDER BY fehlermeldungen.fmid DESC";
...
$updateGoTo = "la45.php?url_user=".$row_rst1['id']."&url_fmid=".$HTTP_POST_VARS["hurl_fmid"]."&goback=la45s.php";
  header(sprintf("Location: %s", $updateGoTo));
}else{$errtxt = "Aktion wählen. Bitte erneut versuchen.";}
...
<table width="883" border="0" cellpadding="0" cellspacing="1">
  <tr> 
    ...
    <td width="71">Lieferort - Rechnungsanschrift</td>
  ...
  <form name="form1" method="post" action="">
    <tr onMouseOver="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onMouseOut="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onMouseDown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
	  ...
	  <a href="la45.php?url_user=<?php echo $row_rst1['id']; ?>&url_fmid=<?php echo $row_rst2['fmid']; ?>"><img src="picture/b_edit.png" alt="bearbeiten" width="16" height="16" border="0"></a>
	  <?php }else{?>
	  <a href="la45.php?url_user=<?php echo $row_rst1['id']; ?>&url_fmid=<?php echo $row_rst2['fmid']; ?>"><img src="picture/fertig.gif" alt="anzeigen" width="16" height="16" border="0" target="_blank"></a>
	  <?php }?>
	  </font></td>
...
?>
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1" face="Arial, Helvetica, sans-serif"><?php echo $row_rst2['lort']; ?>- <?php echo $row_rst2['rort']; ?></font></font></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1" face="Arial, Helvetica, sans-serif"><?php echo $row_rst2['fm1datum']; ?></font>
	  <a href="pdfetikett1.php?url_fmid=<?php echo $row_rst2['fmid']; ?>" target="_blank"><img src="picture/icon_info.gif" alt="Etikett drucken" width="14" height="14" border="0"></a>
...
<p>&nbsp;Statistik: <?php echo $totalRows_rst2 ?> Retouren zur Kommisionierung und Verpackung angelegt.</p>
<p> 
  <?php
