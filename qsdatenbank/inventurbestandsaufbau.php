...
if ($HTTP_POST_VARS['chk_user']>0 && $HTTP_POST_VARS['suchtext']>=100000 && $HTTP_POST_VARS['suchtext2']>=1 && $HTTP_POST_VARS['suchtext3']>=300000) {
...
$totalRows_rst2 = mysql_num_rows($rst2);
  ...
  $insertSQL = sprintf("INSERT INTO check_fid (chk_mat, chk_sn, chk_fid, chk_user, chk_lager, chk_datum) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($HTTP_POST_VARS['suchtext'], "text"),
					   GetSQLValueString($HTTP_POST_VARS['suchtext2'], "text"),
					   GetSQLValueString($HTTP_POST_VARS['suchtext3'], "text"),
...
<p align="center"><strong>ifis Inventurprogramm mit MAT und SN<br>
...
<form name="form2" method="post" action="">
  <p align="center">Material: 
    ...
    <br>
    SN: 
    <input name="suchtext2" type="text" id="suchtext2" maxlength="12">
    <br>
    FID: 
    <input name="suchtext3" type="text" id="suchtext3" maxlength="12">
    <br>
