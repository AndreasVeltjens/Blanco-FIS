...
if ((isset($HTTP_POST_VARS["MM_update"])) && ($HTTP_POST_VARS["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE fehlermeldungen SET sappcna=%s, sapkst=%s WHERE fmid=%s",
...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT fehlermeldungen.fmid, fehlermeldungen.fmsn,fehlermeldungen.fmdatum, fehlermeldungen.fmartikelid, fehlermeldungen.fmfd, fehlermeldungen.fm1, fehlermeldungen.fm2, fehlermeldungen.fm3, fehlermeldungen.fm4, fehlermeldungen.fm5, fehlermeldungen.fm0, fehlermeldungen.fm6, fehlermeldungen.fm6, fehlermeldungen.fm1notes, fehlermeldungen.fm2variante, fehlermeldungen.sappcna, fehlermeldungen.sapsd, fehlermeldungen.sapkst,fehlermeldungen.vkz FROM fehlermeldungen WHERE (fehlermeldungen.fm0=1 AND fehlermeldungen.fm1=1 AND fehlermeldungen.fm2=1  AND fehlermeldungen.sappcna=0 and fehlermeldungen.vkz =0 ) or (fehlermeldungen.fm0=1 AND fehlermeldungen.fm1=1 AND fehlermeldungen.fm2=1 AND fehlermeldungen.sappcna>0 and fehlermeldungen.vkz =3) ORDER BY fehlermeldungen.fmid";
...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="728" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="370"> <div align="right"><strong>PCNA-Auftr&auml;ge- Kontrollmodus 
          2</strong> 
    ...
    <tr> 
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><strong>Auftragsnummern &auml;ndern und Kostenstellen &auml;ndern</strong></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td>&nbsp; </td>
...
<table width="730" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="70">PCNA - KST &auml;ndern</td>
  </tr>
  <?php do { ?>
  <form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <tr onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');">
      <td    bgcolor="#EEEEEE" nowrap="nowrap">	  <?php if ($row_rst2['fmdatum']>=date("Y-m-d H:i:s",time()-100)) {echo "<img src=\"picture/iconAuction_16x16.gif\" alt=\"Achtung. Dieser Datensatz innerhalb der letzten 5 min von einem Benutzer bearbeitet.\">";}?></td>
...
$totalRows_rst7 = mysql_num_rows($rst7);  
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><div align="right"> 
          ...
          <input name="sapkst" type="text" id="sapkst" value="<?php echo $row_rst2['sapkst']; ?>" size="6" maxlength="6">
