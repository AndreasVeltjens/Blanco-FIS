...
if ((isset($HTTP_POST_VARS["MM_update"])) && ($HTTP_POST_VARS["MM_update"] == "form3")) {
  $updateSQL = sprintf("UPDATE qmbmitteilungen SET name=%s, datum=%s, Zeit=%s, lokz=%s, vorlauf=%s, werk=%s, `user`=%s WHERE id_mitt=%s",
...
mysql_select_db($database_nachrichten, $nachrichten);
$query_rst2 = "SELECT * FROM qmbmitteilungen WHERE qmbmitteilungen.id_mitt='$url_id_mitt'";
