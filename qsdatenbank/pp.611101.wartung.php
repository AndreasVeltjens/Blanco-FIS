...
if (($HTTP_POST_VARS['checkbox1']>0) or ($HTTP_POST_VARS['checkbox2']>0) or ($HTTP_POST_VARS['checkbox3']>0) or ($HTTP_POST_VARS['checkbox4']>0) or ($HTTP_POST_VARS['checkbox5']>0) or ($HTTP_POST_VARS['checkbox6']>0) or($HTTP_POST_VARS['checkbox7']>0) or($HTTP_POST_VARS['checkbox8']>0) or($HTTP_POST_VARS['checkbox9']>0) or($HTTP_POST_VARS['checkbox10']>0)) {
	...
	if ($HTTP_POST_VARS['checkbox7']==1) {$Wartungstext.="Entkalkungsanlage i.O. - Sprühkühlung gereinigt. ";}
	if ($HTTP_POST_VARS['checkbox8']==1) {$Wartungstext.="Andockeinheit i.O. ";}
	if ($HTTP_POST_VARS['checkbox9']==1) {$Wartungstext.="Umbau auf Twinsheet-Betrieb  ";}
	if ($HTTP_POST_VARS['checkbox10']==1) {$Wartungstext.="Umbau auf Monosheet-Betrieb ";}
...
if (($HTTP_POST_VARS['checkbox1']>0) or ($HTTP_POST_VARS['checkbox2']>0) or ($HTTP_POST_VARS['checkbox3']>0) or ($HTTP_POST_VARS['checkbox4']>0) or ($HTTP_POST_VARS['checkbox5']>0) or ($HTTP_POST_VARS['checkbox6']>0) or($HTTP_POST_VARS['checkbox7']>0) or($HTTP_POST_VARS['checkbox8']>0) or($HTTP_POST_VARS['checkbox9']>0) or($HTTP_POST_VARS['checkbox10']>0) or($HTTP_POST_VARS['checkbox11']>0)) {
	...
	if ($HTTP_POST_VARS['checkbox7']==1) {$Wartungstext.="Sprühkühlung - Entkalkung n.i.O. - kein Wasser vorhanden.";}
...
?>
    ...
    <td colspan="3"><img src="picture/arrowClose.gif" width="8" height="9"> 
       
      <img src="co15.gantthourex1.php?datum=<?php echo date('Y-m-d',time()); ?>&arbeitsplatztyp=3&layout=780" width="780"></td>
  </tr>
  <?php } ?>
</table>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#6699FF"> 
      ...
      <td colspan="3"> <div align="center"> </div>
        <font size="4"> Lichtschranke Formstation/ Beschickung/ WWW gepr&uuml;ft</font></td>
    ...
    <tr bgcolor="#6699FF"> 
      ...
      <td colspan="3"> <div align="center"> </div>
        <font size="4"> Fensterplatte gereinigt, Dichtung erneuert</font></td>
      <td>&nbsp;</td>
    </tr>
    <tr bgcolor="#CCCCCC"> 
    ...
    <tr bgcolor="#CCCCCC"> 
      ...
      <td colspan="3"><div align="center"> </div>
        <font size="4"> Wasserstand Entkalkungsanlage i.O. - Wasseranschluss Spr&uuml;hk&uuml;hlung 
        ge&ouml;ffnet.</font></td>
    </tr>
    <tr bgcolor="#6699FF"> 
    ...
    <tr bgcolor="#6699FF"> 
      <td><input name="checkbox9" type="checkbox" class="checkboxgross" id="checkbox9" value="1"> 
        <img src="picture/au_shieldgreen.gif" width="29" height="31"></td>
      <td colspan="3"> <div align="center"> </div>
        <font size="4"> Umbau auf Twinsheet-Betrieb</font></td>
    </tr>
    <tr bgcolor="#CCCCCC"> 
      <td><input name="checkbox10" type="checkbox" class="checkboxgross" id="checkbox10" value="1"> 
        <img src="picture/au_shieldgreen.gif" width="29" height="31"></td>
      <td colspan="3"><div align="center"> </div>
        <font size="4"> Umbau auf Monosheet-Betrieb</font></td>
    </tr>
    <tr bgcolor="#CCCCCC"> 
      <td>&nbsp;</td>
      <td>&nbsp;</td>
...
<form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#FF9900"> 
      ...
      <td colspan="3"><font size="4">Fehler: Lichtschranke Formstation/ Beschickung/ 
        WWW gepr&uuml;ft</font></td>
      <td>&nbsp;</td>
    </tr>
    <tr bgcolor="#CCCCCC"> 
      <td> <div align="center"> 
    ...
    <tr bgcolor="#6699FF"> 
      ...
      <td colspan="3" bgcolor="#FF9900"><font size="3">Spr&uuml;hk&uuml;hlung/ 
        Entkalkungsanlage fehlerhaft - Wassermangel, Salztabletten aufgebraucht.</font></td>
    </tr>
    <tr bgcolor="#CCCCCC"> 
      <td> <div align="center"> 
    ...
    <tr bgcolor="#6699FF"> 
      ...
      <td colspan="3" bgcolor="#FF9900"><font size="4">Umbauprobleme auf Twinsheet</font></td>
    </tr>
    <tr bgcolor="#CCCCCC"> 
      <td> <div align="center"> 
          <input name="checkbox10" type="checkbox" class="checkboxgross" id="checkbox10" value="1">
        </div></td>
      <td colspan="3"><font size="4">Umbauprobleme auf Monosheet</font></td>
    </tr>
    <tr bgcolor="#CCCCCC"> 
      <td bgcolor="#FF9900"> <div align="center"> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#CCCCFF"> 
      <td colspan="4"><strong><img src="picture/help2.gif" width="16" height="16" align="absmiddle"> 
        Synchronisation der Antriebe</strong></td>
      <td><input name="url_user" type="hidden" id="url_user" value="<?php echo $url_user; ?>"> 
        <input name="url_id_fhm" type="hidden" id="url_id_fhm" value="<?php echo $fhm_id ?>"> 
        <input name="url_id_fhmea" type="hidden" id="url_id_fhmea" value="6"></td>
    </tr>
    ...
    <tr bgcolor="#CCCCFF"> 
      <td colspan="4"><strong><img src="picture/help2.gif" width="16" height="16" align="absmiddle"> 
        Rezeptur- und Programm- &Auml;nderungen</strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr bgcolor="#CCCCFF"> 
      <td>&nbsp;</td>
