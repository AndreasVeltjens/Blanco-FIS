...
<table width="900" border="0" cellpadding="0" cellspacing="1">
  ...
  mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rststatus = "SELECT fhm_ereignis.datum, fhm_ereignis.id_fhme, fhm_ereignis.id_fhm, fhm_ereignis.beschreibung, fhm_ereignis.id_fhmea, fhm_ereignis.ereigniszeitstempel, fhm_ereignisart.piclink, fhm_ereignisart.name, fhm_ereignis.beschreibung  
...
$totalRows_rststatus = mysql_num_rows($rststatus);
  ...
  ?>
  <?php if ( $row_rststatus['piclink']=="st1.gif") {?>
...
?></select>
	  ...
	  if ($test>=1 && $row_rststatus['piclink']=="st2.gif"){ ?>
        ...
        <?php } ?>
        <?php echo "<img src=\"picture/".$row_rststatus['piclink']."\">".$row_rststatus['name']." - ".substr($row_rststatus['beschreibung'],0,30)." - ".$row_rststatus['datum']." - ".$test; ?></font></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"> 
