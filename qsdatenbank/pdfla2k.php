...
$totalRows_rst4 = mysql_num_rows($rst4);
	...
	$url_nummer="0".$row_rst4['Nummer'];
include('picture/barcodeI25.php');


	if (isset($url_artikelid) && ($url_artikelid>0)) {$stxt=" ";}else{$stxt=" ";}
	...
	/* 	$pdf->SetFont('Helvetica','B',10);
		...
		$pdf->SetFont('Helvetica','',10);
		/* $pdf->Text(20,85,'Leipzig, '.date("d.m.Y",time()));
	 ...
	 */	$pdf->SetFont('Helvetica','B',30);
	 	$pdf->Ln(5);
		$pdf->Text(21,70,utf8_decode($row_rst4['Nummer']));
		$pdf->Ln(5);
		$pdf->SetFont('Helvetica','B',20);
		$pdf->Text(21,80,utf8_decode(wordwrap($row_rst4['Bezeichnung'])));
		$pdf->Ln(10);
	 ...
	 /* für jede Seite */
		...
		$pdf->SetFont('Helvetica','',8);
		$pdf->MultiCell(90,4, utf8_decode(wordwrap($row_rst4['Beschreibung'])),0,"","");
	 ...
	 */	$pdf->Ln(10);
		...
		$pdf->Image($materialbild,20,140,120,80,"","");
