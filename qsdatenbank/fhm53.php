...
{$suchwhere=$suchwere." AND fhm.artikelid=0 ";}
...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT fhm_gruppe.id_fhm_gruppe, fhm_gruppe.piclink, fhm.id_fhm, fhm.id_fhm_gruppe, fhm.name, fhm.lokz, fhm.ortsveraend, fhm.still, fhm.lagerort, fhm.lastmod, fhm.Inventarnummer, fhm.werk, fhm_ereignis.id_fhme, fhm_ereignis.id_fhm, fhm_ereignis.id_fhmea, fhm_ereignis.id_p, fhm_ereignis.datum, fhm_ereignis.beschreibung, fhm_ereignis.lokz, fhm_ereignisart.id_fhmea, fhm_ereignisart.wert, fhm_ereignis.id_ref_fhme, fhm_gruppe.name as gruppe FROM fhm , fhm_gruppe, fhm_ereignis, fhm_ereignisart WHERE fhm.id_fhm_gruppe=fhm_gruppe.id_fhm_gruppe $suchwhere AND fhm_ereignis.id_fhm =fhm.id_fhm and fhm_ereignis.id_fhmea = fhm_ereignisart.id_fhmea AND fhm_ereignis.lokz=0 AND fhm_ereignisart.wert = 1 ORDER BY fhm_ereignis.datum desc";
...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst4 = "SELECT fhm_ereignis.id_fhme, fhm_ereignis.id_fhm, fhm_ereignis.id_ref_fhme FROM fhm_ereignis WHERE fhm_ereignis.id_fhm='$row_rst2[id_fhm]' AND fhm_ereignis.id_ref_fhme='$row_rst2[id_fhme]' AND fhm_ereignis.lokz=0";
...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="730" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="90" rowspan="3"><img src="picture/0d1e0a6a3e.gif" width="30" height="31"></td>
      <td width="119">Aktionen W&auml;hlen:</td>
      <td width="205"> <img src="picture/b_drop.png" width="16" height="16"> <input name="cancel" type="submit" id="cancel2" value="Zur&uuml;ck"></td>
...
do {  
?>
          <option value="<?php echo $row_rst3['id_fhm_gruppe']?>"<?php if (!(strcmp($row_rst3['id_fhm_gruppe'], $HTTP_POST_VARS["select"]))) {echo "SELECTED";} ?>><?php echo $row_rst3['name']?></option>
          <?php
...
?>
        ...
        auch Servicet&uuml;ren und Ger&auml;te anzeigen</td>
    </tr>
    <tr> 
      <td>Suchtext</td>
      <td> <input name="suchtext" type="text" id="suchtext" value="<?php echo $HTTP_POST_VARS['suchtext']; ?>"> 
      </td>
      <td> <input name="suchen" type="submit" id="suchen" value="Suchen">
        - St&ouml;rungsliste -</td>
    </tr>
  </table>
  <br>
...
<table width="836" border="0" cellpadding="0" cellspacing="1">
  <tr>
    ...
    <td width="23">Datum</td>
    <td width="23">St&ouml;rung</td>
    ...
    <td width="99"><strong>Inventar-<br>
      nummer</strong></td>
    <td width="65"><strong>Lagerort</strong></td>
    <td width="273"><strong>-Werk</strong></td>
  </tr>
  <?php do { ?>
  <?php 
  /* Abfrage nac h Status Rückmeldung auf Ereignis */
  
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst4 = "SELECT * FROM fhm_ereignis WHERE fhm_ereignis.id_fhm='$row_rst2[id_fhm]' AND fhm_ereignis.id_ref_fhme='$row_rst2[id_fhme]'";
$rst4 = mysql_query($query_rst4, $qsdatenbank) or die(mysql_error());
$row_rst4 = mysql_fetch_assoc($rst4);
$totalRows_rst4 = mysql_num_rows($rst4);
  ...
  <form name="form1" method="post" action="">
    <tr onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');">
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><?php if ($totalRows_rst4 > 0) { // Show if recordset not empty ?>
        <img src="picture/st1.gif" alt="Reparatur ist erfolgt" width="15" height="15">
        <?php } // Show if recordset not empty ?> <?php if ($totalRows_rst4 == 0) { // Show if recordset empty ?>
        <img src="picture/st3.gif" alt="St&ouml;rung noch nicht r&uuml;ckgemeldet" width="15" height="15"> 
        <?php } // Show if recordset empty ?></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><img src="picture/<?php echo $row_rst2['piclink']; ?>" alt="<?php echo $row_rst2['gruppe']; ?>" width="15" height="15"></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><?php echo $row_rst2['datum']; ?></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><?php echo wordwrap($row_rst2['beschreibung'],40,"<br>",255); ?></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"> 
        <?php if (!(strcmp($row_rst2['ortsveraend'],1))) {echo "<img src=\"picture/eo.gif\" alt=\"ortsveränderliches Ger&auml;t\">";}else{echo "<img src=\"picture/st6.gif\" >";}  ?>
      </td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"> 
        <?php if (!(strcmp($row_rst2['still'],1))) {echo "<img src=\"picture/st3.gif\" alt=\"stillgelegt\">";}else{echo "<img src=\"picture/st6.gif\" >";} ?>
      </td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"> 
        <?php if (!(strcmp($row_rst2['lokz'],1))) {echo "<img src=\"picture/b_drop.png\" alt=\"gel&ouml;schtes Ger&auml;t\">";}else{echo "<img src=\"picture/st6.gif\" >";} ?>
      </td>
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"> <font size="1" face="Arial, Helvetica, sans-serif"> 
        <?php echo wordwrap($row_rst2['name'],40,"<br>",240); ?> 
...
<p>&nbsp;Statistik: <?php echo $totalRows_rst2 ?> St&ouml;rungen bei Fertigungshilfsmittel, Werkzeuge oder Equipments 
  angelegt.</p>
<p> 
  <?php
...
<p><img src="picture/st1.gif" alt="ee" width="15" height="15"> St&ouml;rung behoben<br>
  <img src="picture/st2.gif" width="15" height="15"> in Arbeit<br>
  <img src="picture/st3.gif" alt="djkdjhjdh" width="15" height="15"> bisher keine 
  Aktion auf diese St&ouml;rung r&uuml;ckgemeldet.</p>
