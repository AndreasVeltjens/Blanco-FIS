...
if ((isset($HTTP_POST_VARS["MM_update"])) && ($HTTP_POST_VARS["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE userprofile SET name=%s, datum=%s, `user`=%s, lokz=%s WHERE upid=%s",
                       ...
                       GetSQLValueString($HTTP_POST_VARS['hupid'], "int"));
...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="614" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="274"> <div align="right">
          <input name="add" type="submit" id="add" value="Rechte zuweisen">
  ...
  <table width="614" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td width="145">ID</td>
      <td width="466">&nbsp;<?php echo $row_rst2['upid']; ?> </td>
      <td width="3">&nbsp;</td>
    </tr>
    <tr> 
      <td>Name</td>
