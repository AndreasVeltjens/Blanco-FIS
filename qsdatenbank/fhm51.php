...
$updateGoTo = "fhm12.php?url_user=".$row_rst1['id']."&url_id_fhm=".$HTTP_POST_VARS["hurl_id_fhm"]."&url_suchtext=".$HTTP_POST_VARS["suchtext"]."&goback=fhm51";
  header(sprintf("Location: %s", $updateGoTo));
}else{$errtxt = "Aktion wählen. Bitte erneut versuchen.";}

if ((isset($HTTP_POST_VARS["ereignis"])) ) {
$updateGoTo = "fhm121.php?url_user=".$row_rst1['id']."&url_id_fhm=".$HTTP_POST_VARS["hurl_id_fhm"]."&url_suchtext=".$HTTP_POST_VARS["suchtext"]."&goback=fhm51";
  header(sprintf("Location: %s", $updateGoTo));
}else{$errtxt = "Aktion wählen. Bitte erneut versuchen.";}
...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="730" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="90" rowspan="3"><img src="picture/ortsveraeand.png" width="124" height="127"></td>
...
?>
    ...
    <tr> 
      ...
      <td> <input name="suchen" type="submit" id="suchen" value="Suchen">
        - Nur aktive Ortsver&auml;nderliche Ger&auml;te - </td>
    </tr>
  </table>
  <br>
...
<table width="764" border="0" cellpadding="0" cellspacing="1">
  <tr> 
    ...
    <td width="273"><strong>Lagerort-Werk</strong></td>
  </tr>
  <?php do { ?>
  <form name="form1" method="post" action="">
    <tr onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><div align="right"> 
          <font size="1"><?php echo substr($row_rst2['lagerort'],0,15)." - ".$row_rst2['werk']; ?></font><font size="1" face="Arial, Helvetica, sans-serif"> 
          <input name="hurl_user" type="hidden" id="hurl_user" value="<?php echo $row_rst1['id']; ?>">
...
<p>&nbsp;Statistik: <?php echo $totalRows_rst2 ?> Fertigungshilfsmittel, Werkzeug oder Equipment angelegt.</p>
<p> 
  <?php
