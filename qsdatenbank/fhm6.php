...
$suchtext=" WHERE kundendaten.service=1 and (kundendaten.idk like '".$HTTP_POST_VARS["suchtext"]."' OR kundendaten.firma like '%".$HTTP_POST_VARS["suchtext"]."%' OR kundendaten.ort like '%".$HTTP_POST_VARS["suchtext"]."%' OR plz like '".$HTTP_POST_VARS["suchtext"]."' )";}
else{$suchtext="WHERE kundendaten.service=1";}
...
<input name="suchtext" type="text" id="suchtext" value="<?php echo utf8_decode($HTTP_POST_VARS['suchtext']); ?>">
      ...
      <td>Suche in Name, Ort, PLZ und Kundenservicenummer</td>
    </tr>
  </table>
  <br>
...
<table width="730" border="0" cellpadding="0" cellspacing="1">
  ...
  <tr> 
    <td width="87"><strong>Kunden-Nr.</strong></td>
    <td width="110"><strong>Firmenname</strong></td>
    <td width="45"><strong>Stra&szlig;e</strong></td>
    <td width="27">PLZ</td>
    <td width="21">Ort</td>
    <td width="64">Fax</td>
...
<?php  $buchstabealt ="";?>
  ...
  <form name="form1" method="post" action="">
   ...
   if ($buchstabealt!= substr((utf8_decode($row_rst2['firma'])),0,1))  {  ?>
    <tr bgcolor="#CCCCCC">
      <td colspan="9" nowrap="nowrap"><img src="picture/s_tbl.png" width="16" height="16"> 
        <?php echo  substr( (utf8_decode($row_rst2['firma'])),0,1) ?> 
      </td>
    </tr>
	<?php } ?>
	
    <tr onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<?php echo $row_rst2['kundenummer']; ?></font></td>
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1">&nbsp;</font><a href="pdfetikett2.php?url_idk=<?php echo $row_rst2['idk']; ?>" target="_blank"><img src="picture/information.gif" alt="Versandetikett anzeigen" width="16" height="16" border="0" align="absmiddle"></a><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"><?php echo $row_rst2['idk']; ?></font><font size="1"> 
        <input name="hurl_idk" type="hidden" id="hurl_idk" value="<?php echo $row_rst2['idk']; ?>">
        <a href="mailto:<?php echo utf8_decode($row_rst2['email']); ?>" target="_blank"><img src="picture/anschreiben.gif" alt="E-Mail erstellen" width="18" height="18" border="0"></a></font></td>
...
<p>&nbsp;<a href="<?php printf("%s?pageNum_rst2=%d%s", $currentPage, 0, $queryString_rst2); ?>">First</a> 
  ...
  - Servicepartner: <?php echo ($startRow_rst2 + 1) ?> bis <?php echo min($startRow_rst2 + $maxRows_rst2, $totalRows_rst2) ?><font size="2" face="Arial, Helvetica, sans-serif"> </font> </p>
<p>&nbsp;Statistik: <?php echo $totalRows_rst2 ?> Serivepartner angelegt.</p>
<p> 
  <?php
