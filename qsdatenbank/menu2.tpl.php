...
$str1="<tr><td bgcolor=\"#CCCCCC\"><font size=\"2\">";
$str2="</font></td></tr>";
$pic="<img src=\"picture/";
...
/* aktives Menu */
$str3="<tr><td bgcolor=\"#FF6600\"><font size=\"2\">";
$str4="</font> <img src=\"picture/b_edit.png\" width=\"16\" height=\"16\" align=\"absmiddle\" border=\"0\"></td></tr>";
/* Zeige aktives Menu */
$a=0;
...
<table width="200" border="0" align="left" cellpadding="0" cellspacing="1">
  <tr> 
    <td bgcolor="#000066"><div align="left"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><a href="sap/openmd04.sap" target="_blank"><img src="picture/sap.png" alt="&Ouml;ffene SAP-Logon " width="16" height="16" border="0" align="absmiddle">SAP 
        Login</a> <a href="http://intranet.blanco.de" target="_blank">BLANCO Intranet</a></font></div></td>
  </tr>
...
if ($totalRows_rstgetuserright>0 ){
		...
		$str1="<tr onMouseOver=\"setPointer(this, 1, 'over', '#EEEEEE', '#CCCCCC', '#FFCC99');\" onMouseOut=\"setPointer(this, 1, 'out', '#EEEEEE', '#CCCCCC', '#FFCC99');\" onMouseDown=\"setPointer(this, 1, 'click', '#EEEEEE', '#CCCCCC', '#FFCC99');\" ><td bgcolor=\"#CCCCCC\" nowrap=\"nowrap\"><font size=\"1\">";
	...
	$d=$i;/* Merker aktuelles Modul */
		...
		if ($vis>0){
				...
				$str=$str1;
			     if ( ($aktiv_url_id_kz>0) or ($show_pareto>0 )){
				                $aktiv_url_id_kz1="&url_id_kz=".$aktiv_url_id_kz."&url_user=15&show_pareto=".$aktiv_show_pareto;
								$aktiv_show_pareto1="&url_user=15&show_pareto=".$aktiv_show_pareto;
					
							if (($aktiv_url_id_kz1==$Modul[$i][4]) or ($aktiv_show_pareto1==$Modul[$i][4])) {
	...
	echo $str;
 	...
 	$i= $i+1;
	$laytab=substr($Modul[$i][0],0,3);
  } while ($i<120); 
   ?> 
</table>
<tr>    
  <td> <table width="750" border="0" cellpadding="0" cellspacing="1">  
    <tr>
   <td>
