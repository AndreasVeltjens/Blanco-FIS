...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT * FROM kennzahlen ORDER BY kennzahlen.gruppe, kennzahlen.name";
  ...
  <table width="730" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="351"> <div align="right"> 
          ...
          <input name="new" type="submit" id="new" value="Neue Visualisierung anlegen">
        </div></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td>&nbsp;</td>
      <td>&nbsp; </td>
      <td><div align="right"><font size="4">alle Werke</font></div></td>
    </tr>
  </table>
  <br>
...
<table width="1048" border="0" cellpadding="0" cellspacing="1">
  <tr> 
    ...
    <td width="95"><div align="right"><strong>x-Achse</strong></div></td>
    <td width="110"><div align="right"><strong>y-Achse</strong></div></td>
  ...
  <form name="form1" method="post" action="">
    ...
    <tr onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1" face="Arial, Helvetica, sans-serif"> 
        ...
        <?php } // Show if recordset empty ?>
        </font><a href="vis2.php?url_user=<?php echo $row_rst1['id'];?>&url_id_kz=<?php echo $row_rst2['id_kz']; ?>&goback=vis1" target="_blank"><img src="picture/column-chart.gif" alt="Diagramm anzeigen" width="16" height="16" border="0"></a></td>
