...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="730" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td colspan="4"><strong><?php echo $Modul[$d][0]." "; echo $Modul[$d][1]; ?>- 
        Anzeige f&auml;lliger Ger&auml;tepr&uuml;fungen zur Kalibrierung</strong></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td width="86" rowspan="3"><img src="picture/messmittel.png" width="82"></td>
...
?>
        ...
        <select name="select2">
          ...
          fällige Prüfungen anzeigen</option>
...
$totalRows_rststatus = mysql_num_rows($rststatus);
  ...
  if (($id_fhm_old<>$id_fhm)&& ($id_p_old<>$row_rst2['id_p'])) {
  ...
  <?php }
  	$id_fhm_old=$row_rst2['id_fhm'];
   $id_p_old=$row_rst2['id_p'];
   ?>
...
<p>Statistik: <?php echo $totalRows_rst2 ?> Messmittel und Pr&uuml;fmittel-Equipment angelegt.<br>
  Funktionsebene 2</p>
<p> 
  <?php
