...
if ((isset($HTTP_POST_VARS["save"]))) {
  $insertSQL = sprintf("INSERT INTO pruefungen (name, soll, einheit, ugw, ogw, lokz, memo) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
  ...
  <table width="614" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="153">Beschreibung</td>
      <td width="442"> <textarea name="memo" cols="50" rows="8" id="memo"><?php echo $row_rst2['memo']; ?></textarea></td>
      <td width="19">&nbsp;</td>
    </tr>
    <tr> 
      <td>SOLLwert</td>
    ...
    <tr> 
      <td>Einheit</td>
      <td> <input name="einheit" type="text" id="einheit" value="<?php echo $row_rst2['einheit']; ?>"></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td height="25">UGW</td>
