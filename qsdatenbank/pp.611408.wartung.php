...
if (($HTTP_POST_VARS['checkbox1']>0) or ($HTTP_POST_VARS['checkbox2']>0) or ($HTTP_POST_VARS['checkbox3']>0) or ($HTTP_POST_VARS['checkbox4']>0) or ($HTTP_POST_VARS['checkbox5']>0) or ($HTTP_POST_VARS['checkbox6']>0) or($HTTP_POST_VARS['checkbox7']>0) or($HTTP_POST_VARS['checkbox8']>0) or($HTTP_POST_VARS['checkbox9']>0) or($HTTP_POST_VARS['checkbox10']>0)) {
	...
	if ($HTTP_POST_VARS['checkbox1']==1) {$Wartungstext.="Papier, Verpackungsmittel ausreichend vorhanden ";}	
	if ($HTTP_POST_VARS['checkbox2']==1) {$Wartungstext.="  ";}
	if ($HTTP_POST_VARS['checkbox3']==1) {$Wartungstext.="  ";}
	if ($HTTP_POST_VARS['checkbox4']==1) {$Wartungstext.="FIS Versandmeldung i.0.  ";}
	if ($HTTP_POST_VARS['checkbox5']==1) {$Wartungstext.="Bändelmaschine i.O. ";}
	if ($HTTP_POST_VARS['checkbox6']==1) {$Wartungstext.="SAP-Terminal i.O.";}
...
if (($HTTP_POST_VARS['checkbox1']>0) or ($HTTP_POST_VARS['checkbox2']>0) or ($HTTP_POST_VARS['checkbox3']>0) or ($HTTP_POST_VARS['checkbox4']>0) or ($HTTP_POST_VARS['checkbox5']>0) or ($HTTP_POST_VARS['checkbox6']>0) or($HTTP_POST_VARS['checkbox7']>0) or($HTTP_POST_VARS['checkbox8']>0) or($HTTP_POST_VARS['checkbox9']>0) or($HTTP_POST_VARS['checkbox10']>0) or($HTTP_POST_VARS['checkbox11']>0)) {
	...
	if ($HTTP_POST_VARS['checkbox5']==1) {$Wartungstext.="SAP Terminal ohne Funktion";}
	...
	if ($HTTP_POST_VARS['checkbox11']==1) {$Wartungstext.="unbekanntes Problem, Verpacken nicht möglich ";}
...
<?php
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_anzahlverkauft = "SELECT count(fid) as anzahl FROM fertigungsmeldungen WHERE versendetam>=DATE_SUB(now(),interval '60:10' MINUTE_SECOND) AND verkauftam > '0000-00-00 00:00:00' AND versendetuser='$url_user'";
...
<?php
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_anzahlverkauft2 = "SELECT count(fid) as anzahl FROM fertigungsmeldungen WHERE versendetam>=DATE_SUB(now(),interval '360:00' MINUTE_SECOND) AND verkauftam > '0000-00-00 00:00:00' AND versendetuser='$url_user'";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td width="297"><div align="center"><a href="pp.<?php echo $location ?>.php?url_user=<?php echo $url_user ?>&action=auftragbearbeiten"><strong><font size="+2"><img src="picture/icon_gr_tarifkonditionen.gif" width="65" height="75" border="0" align="absmiddle"> 
        Versenden</font></strong></a></div></td>
    <td width="231"><div align="right"><a href="pp.<?php echo $location ?>.php?url_user=<?php echo $url_user ?>&action=stornoversenden"><strong><font size="+2"><img src="picture/reply1.gif" width="23" height="20" border="0"><font size="+1"> 
        zur&uuml;ck ins Lager</font></font></strong></a></div></td>
...
?>
    ...
    <td colspan="4">
      <?php include('pp.letzteversendet.php'); ?>
      &nbsp;</td>
  </tr>
  <?php } ?>
</table>
  ...
  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#6699FF"> 
      ...
      <td colspan="3"> <div align="center"> </div>
        <font size="4"> Papier, Ettiketten, Verpackungsmittel ausreichend vorhanden</font></td>
    ...
    <tr bgcolor="#6699FF"> 
      ...
      <td colspan="3"><div align="left"><strong>FIS Versandmeldung i.O.</strong></div></td>
      <td>&nbsp;</td>
    </tr>
    <tr bgcolor="#CCCCCC"> 
      ...
      <td colspan="3"><div align="left"><font size="4">B&auml;ndelmaschine i.O.</font></div></td>
    ...
    <tr bgcolor="#6699FF"> 
      ...
      <td colspan="3"> <div align="center"> </div>
        <font size="4">SAP- Terminal i.O.</font></td>
    </tr>
    <tr bgcolor="#CCCCCC"> 
      <td> <div align="left"> 
...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
  <form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <tr> 
      ...
      <td width="236" bgcolor="#CCCCFF"><img src="picture/icon_gr_tarifkonditionen.gif" width="65" height="75" align="absmiddle"> 
        <strong>Versand melden</strong></td>
  ...
  <tr bgcolor="#CCCCFF"> 
    ...
    <td colspan="3"><input name="url_user" type="hidden" id="url_user" value="<?php echo $url_user; ?>"> 
      ...
      <form action="<?php echo $editFormAction; ?>" method="POST" name="form2">
        ...
        <input type="Submit" name="versenden" class="buttongross" value="Versenden">
        ...
        <p> 
          ...
          <input name="hurl_seite" type="hidden" id="hurl_seite" value="<?php echo $editFormAction; ?>">
          Anzahl der Versandmeldungen in der letzten Zeit: <font size="7"><strong><?php echo $row_anzahlverkauft['anzahl']; ?></strong></font> 
        </p>
        <input type="hidden" name="MM_update" value="form2">
        Anzahl der Versandmeldungen in den letzten 12- Stunden des Mitarbeiters: 
 ...
 <?php if ($url_user>0 and $action=="stornoversenden"){?>
  <?php $oktxt.=" Zum Speichern Artikel anwählen und Neues Ger&auml;t dr&uuml;cken.";?>
</p>
...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
  <form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <tr> 
      ...
      <td width="103" bgcolor="#FFFFFF">&nbsp;</td>
      <td width="236" bgcolor="#CCCCFF"><img src="picture/icon_gr_tarifkonditionen.gif" width="65" height="75" align="absmiddle"> 
        <strong>Versandmeldung stornieren</strong></td>
      <td width="183" bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
    <?php if (!isset($materialnummer) and (!isset($materialnummer1) and !isset($materialnummer2) and !isset($materialnummer3) and !isset($materialnummer4) and !isset($materialnummer5))  ){ ?>
    <tr bgcolor="#CCCCFF"> 
  ...
  <tr bgcolor="#FF6600"> 
    ...
    <td colspan="3"><input name="url_user" type="hidden" id="url_user" value="<?php echo $url_user; ?>"> 
      ...
      <form action="<?php echo $editFormAction; ?>" method="POST" name="form2" >
        Scan Barcode: 
        <input name="suchtext" type="text" class="eingabefeld" id="suchtext" value="" size="20" maxlength="20">
        <input type="Submit" name="stornoversenden" class="buttongross" value="ins Lager H011 zur&uuml;ck">
        <input name="hurl_seite" type="hidden" id="hurl_seite" value="<?php echo $editFormAction; ?>">
        <hr>
        <p> 
          <input name="hurl_user_id" type="hidden" id="hurl_user_id" value="<?php echo $url_user; ?>">
