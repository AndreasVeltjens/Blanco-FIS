...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT artikeldaten.artikelid, artikeldaten.bezeichnung,fehler.fname,fehler.fkurz,fehler.fid ,  date_format(fehlermeldungen.fm1datum,\"%Y %M\") as fehlerdatum, count(linkfehlerfehlermeldung.lffid) as anzahl, linkfehlerfehlermeldung.fmid, linkfehlerfehlermeldung.fid, linkfehlerfehlermeldung.lokz FROM artikeldaten, fehlermeldungen, fehler, linkfehlerfehlermeldung, entscheidung WHERE artikeldaten.artikelid=fehlermeldungen.fmartikelid $artikel $fehler and linkfehlerfehlermeldung.fid=fehler.fid AND linkfehlerfehlermeldung.lokz =0 and linkfehlerfehlermeldung.fmid = fehlermeldungen.fmid AND entscheidung.gvwl=1 AND entscheidung.entid =fehlermeldungen.fm2variante GROUP BY date_format(fehlermeldungen.fm1datum,\"%Y %M\") ORDER BY fehlermeldungen.fm1datum desc limit 0,200";
