...
if ((isset($HTTP_POST_VARS["save"]))) {
  $updateSQL = sprintf("UPDATE zeichnungen SET zeichnungsnummer=%s, Ursprungszeichnung=%s, art=%s, revision=%s, beschreibung=%s, datum=%s, bemerkung=%s, id_ablage=%s, lokz=%s WHERE id_zeichnung=%s",
                       ...
                       GetSQLValueString($HTTP_POST_VARS['hurl_id_zeichnung'], "int"));
...
$GoTo = "k1.php?url_user=".$row_rst1['id']."&url_suchtext=".$HTTP_POST_VARS["url_suchtext"]."&url_ablage=".$HTTP_POST_VARS["url_ablage"];
...
<form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
  ...
  <table width="614" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td> <input name="hurl_id_zeichnung" type="hidden" id="hurl_id_zeichnung2" value="<?php echo $row_rst2['id_zeichnung']; ?>"></td>
    </tr>
    <tr> 
      ...
      <td>
<input name="url_suchtext" type="hidden" id="url_suchtext" value="<?php echo $url_suchtext; ?>"></td>
    </tr>
  </table>
  ...
  <table width="614" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      ...
      <td width="33"><input name="url_ablage" type="hidden" id="url_ablage" value="<?php echo $url_ablage ?>"></td>
    </tr>
    <tr> 
      <td>Datum:</td>
    ...
    <tr> 
      <td>Ablage</td>
      <td> <select name="id_ablage" id="id_ablage">
          <?php
do {  
?>
...
?>
    ...
    <tr>
      ...
      <td>
<input <?php if (!(strcmp($row_rst2['lokz'],1))) {echo "checked";} ?> name="lokz" type="checkbox" id="lokz" value="checkbox"></td>
      <td>&nbsp;</td>
    </tr>
  </table>
