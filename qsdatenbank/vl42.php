...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT * FROM auslieferungen WHERE auslieferungen.typ = 4 ORDER BY auslieferungen.paletten asc";
...
<table width="1044" border="0" cellspacing="0" cellpadding="0">
  <tr> 
      <td colspan="3"><strong>vl42 Produktionsprogramm planen GEISS DU 1500 T6 
        Twinsheet </strong></td>
  </tr>
  <tr> 
...
<table width="1055" border="0" cellpadding="0" cellspacing="0">
  ...
  <form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <tr onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><div align="center"><?php echo $row_rst2['nummer']; ?></div></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><div align="center"><?php echo $row_rst2['stueck']; ?></div></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><div align="center"><?php echo round($row_rst2['zeit']*$row_rst2['stueck']/60/60,1); ?></div></td>
