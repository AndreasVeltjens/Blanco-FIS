...
WHERE auslieferungen.typ = 1 AND artikeldaten.Nummer=auslieferungen.nummer AND auslieferungen.lokz=0 AND artikeldaten.Kontierung like '%ersatz%' ORDER BY  artikeldaten.Gruppe asc , artikeldaten.bezeichnung asc";
...
<table width="980" border="0" cellpadding="0" cellspacing="1">
  <tr> 
    <td height="24"><strong>Ersatzteile</strong></td>
    <td>&nbsp;</td>
  </tr>
  <tr> 
