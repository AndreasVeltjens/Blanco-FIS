...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="980" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td colspan="2"><strong><font size="5" face="Arial, Helvetica, sans-serif">BLANCOTHERM K - Speiseverteilung</font></strong></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td colspan="2"></td>
    ...
    <tr> 
      <td colspan="3"><div align="center"><img src="media/blancotherm1.png"> 
        </div></td>
    </tr>
  </table>
  <br>
