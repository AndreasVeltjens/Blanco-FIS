...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT fhm_gruppe.id_fhm_gruppe, fhm_gruppe.piclink, fhm.id_fhm, fhm.id_fhm_gruppe, fhm.name, fhm.lokz, fhm.ortsveraend, fhm.still, fhm.lagerort, fhm.lastmod, fhm.Inventarnummer, fhm.werk, fhm.ortsfest FROM fhm , fhm_gruppe WHERE fhm.id_fhm_gruppe=fhm_gruppe.id_fhm_gruppe $suchwhere ORDER BY fhm.name";
...
$updateGoTo = "fhm12.php?url_user=".$row_rst1['id']."&url_id_fhm=".$HTTP_POST_VARS["hurl_id_fhm"]."&url_suchtext=".$HTTP_POST_VARS["suchtext"];
  header(sprintf("Location: %s", $updateGoTo));
}else{$errtxt = "Aktion wählen. Bitte erneut versuchen.";}

if ((isset($HTTP_POST_VARS["ereignis"])) ) {
$updateGoTo = "fhm121.php?url_user=".$row_rst1['id']."&url_id_fhm=".$HTTP_POST_VARS["hurl_id_fhm"]."&url_suchtext=".$HTTP_POST_VARS["suchtext"];
  header(sprintf("Location: %s", $updateGoTo));
}else{$errtxt = "Aktion wählen. Bitte erneut versuchen.";}


if ((isset($HTTP_POST_VARS["new"])) ) {
$updateGoTo = "fhm11.php?url_user=".$row_rst1['id']."&goback=fhm1.php";
  header(sprintf("Location: %s", $updateGoTo));
}else{$errtxt = "Aktion wählen. Bitte erneut versuchen.";}
...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="730" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="86" rowspan="3"><img src="picture/allg-einstellungen.gif" width="70" height="50"></td>
...
<table width="840" border="0" cellpadding="0" cellspacing="1">
  <tr> 
    ...
    <td width="58">Typenschild</td>
    <td width="519"><strong>Stamdaten</strong></td>
  </tr>
  <?php do { ?>
  <form name="form1" method="post" action="">
    <tr onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
      ...
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1"><a href="pdfetifhm1.php?url_id_fhm=<?php echo $row_rst2['id_fhm']?>" target="_blank"><img src="picture/information.gif" alt="Aufkleber drucken" width="16" height="16" border="0" align="absmiddle"></a></font></td>
