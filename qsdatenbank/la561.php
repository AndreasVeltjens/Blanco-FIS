...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT artikeldaten.artikelid, artikeldaten.bezeichnung,date_format(fehlermeldungen.fm5datum,\"%Y %M\") as fehlerdatum, count(fehlermeldungen.fmid) as anzahl,avg(datediff(fehlermeldungen.fm5datum,fehlermeldungen.fm3datum)) as mittelwert, entscheidung.entid, entscheidung.lokz, entscheidung.gvwl FROM artikeldaten, fehlermeldungen, entscheidung WHERE artikeldaten.artikelid=fehlermeldungen.fmartikelid $suchkrit and fehlermeldungen.fm6=1 AND entscheidung.gvwl=1 AND entscheidung.entid =fehlermeldungen.fm2variante GROUP BY date_format(fehlermeldungen.fm5datum,\"%Y %M\") ORDER BY fehlermeldungen.fm5datum desc limit 0,100";
  ...
  <table width="728" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="332"> <div align="right"> 
          ...
          durchschnittliche Reparaturzeit <br>
          innerhalb Gew&auml;hrleistung</div></td>
    </tr>
    <tr> 
