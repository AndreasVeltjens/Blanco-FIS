...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php if ($action==""){?>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="2" rowspan="4"><img src="picture/arrowClose.gif" width="8" height="9"> 
      Wartungsdokumentation<br> 
...
?>
    ...
    <td colspan="2" rowspan="3" bgcolor="#FFFFFF"> <div align="center">
        <iframe style='zoom:80%; width:700px; height:600px;'  src='http://192.168.39.16/currentstatus.rb'></iframe>
      </div></td>
    <td><img src="pp.odoex05.php?url_id_pruef=50" height="150" ></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td><img src="pp.odoex05.php?url_id_pruef=51" height="150" ></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td><img src="pp.odoex05.php?url_id_pruef=52" height="150" ></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="3"> </td>
  </tr>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#CCCCCC"> 
      <td><input name="checkbox5" type="checkbox" class="checkboxgross" id="checkbox5" value="checkbox"> 
        <img src="picture/star_yellow_preferences.gif" width="16" height="16" align="absmiddle"></td>
      <td colspan="3"><div align="center"> </div>
        <font size="4">&Ouml;lstand Hydraulikaggregat gepr&uuml;ft und aufgef&uuml;llt, 
        Maschine gereinigt.</font></td>
