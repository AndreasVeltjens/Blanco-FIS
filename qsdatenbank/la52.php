...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "select artikeldaten.artikelid, artikeldaten.bezeichnung,date_format(fehlermeldungen.fm1datum,\"%Y %M\") as fehlerdatum, count(fehlermeldungen.fmid) as anzahl from artikeldaten, fehlermeldungen where artikeldaten.artikelid=fehlermeldungen.fmartikelid and fmartikelid=$HTTP_POST_VARS[artikelid] group by date_format(fehlermeldungen.fm1datum,\"%Y %M\") order by fehlermeldungen.fm1datum desc limit 0,100";
