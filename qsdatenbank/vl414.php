...
mysql_select_db($database_qsdatenbank, $qsdatenbank);
$query_rst2 = "SELECT * FROM auslieferungen WHERE typ = 6 ORDER BY paletten ASC";
...
<table width="730" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td colspan="3"><strong>vl414-Fertigungsmeldungen Schwei&szlig;en und Fr&auml;sen</strong></td>
  </tr>
  <tr> 
...
<table width="1442" border="0" cellpadding="0" cellspacing="0">
  <tr class="value"> 
    ...
    <td><font size="1">&nbsp;</font></td>
    <td><font size="1">&nbsp;</font></td>
    <td><font size="1"><em><strong>Fertigungsmenge</strong></em></font></td>
    <td><font size="1">&nbsp;</font></td>
    <td><font size="1"><em><strong>Fertigungsmenge</strong></em></font></td>
    <td><font size="1">&nbsp;</font></td>
    <td><font size="1"><em><strong>Fertigungsmenge</strong></em></font></td>
  ...
  <tr class="value"> 
    ...
    <td><font size="1">&nbsp;</font></td>
    <td><font size="1">&nbsp;</font></td>
    <td bgcolor="#3399CC"><font size="1">Montag</font></td>
    <td bgcolor="#3399CC"><font size="1">&nbsp;</font></td>
    <td bgcolor="#9999FF"><font size="1">Dienstag</font></td>
    <td bgcolor="#9999FF"><font size="1">&nbsp;</font></td>
    <td bgcolor="#3399CC"><font size="1">Mittwoch</font></td>
    <td bgcolor="#3399CC"><font size="1">&nbsp;</font></td>
    <td bgcolor="#9999FF"><font size="1">Donnerstag</font></td>
    <td bgcolor="#9999FF"><font size="1">&nbsp;</font></td>
    <td bgcolor="#3399CC"><font size="1">Freitag</font></td>
    <td bgcolor="#3399CC"><font size="1">&nbsp;</font></td>
    <td bgcolor="#9999FF"><font size="1">Sonnabend</font></td>
    <td bgcolor="#9999FF"><font size="1">&nbsp;</font></td>
    <td><font size="1">&nbsp;</font></td>
  </tr>
  <tr class="value"> 
    ...
    <td width="75"><font size="1"><em><strong>Material<br>
      nummer</strong></em></font></td>
    <td width="68"><p align="center"><font size="1"><em><strong>St&uuml;ck</strong></em></font></p></td>
    <td width="109" bgcolor="#33CCFF"><div align="center"><font size="1"><em><strong> 
        G -Fr&uuml;hschicht -A<br>
        </strong></em></font></div></td>
    <td width="106" bgcolor="#0099FF"><div align="center"><font size="1"><em><strong>G 
        -</strong></em>Sp&auml;tschicht<em><strong>-A</strong></em></font></div></td>
    <td width="109" bgcolor="#99FFFF"><div align="center"><font size="1"><em><strong>G-Fr&uuml;hschicht-A<br>
        </strong></em></font></div></td>
    <td width="106" bgcolor="#99CCFF"><div align="center"><font size="1">G</font><font size="1">-Sp&auml;tschicht-A</font></div></td>
    <td bgcolor="#33CCFF"><div align="center"><font size="1"><em><strong> G -Fr&uuml;hschicht 
        -A<br>
        </strong></em></font></div></td>
    <td bgcolor="#0099FF"><div align="center"><font size="1"><em><strong>G -</strong></em>Sp&auml;tschicht<em><strong>-A</strong></em></font></div></td>
    <td bgcolor="#99FFFF"><div align="center"><font size="1"><em><strong>G-Fr&uuml;hschicht-A<br>
        </strong></em></font></div></td>
    <td bgcolor="#99CCFF"><div align="center"><font size="1">G</font><font size="1">-Sp&auml;tschicht-A</font></div></td>
    <td bgcolor="#33CCFF"><div align="center"><font size="1"><em><strong> G -Fr&uuml;hschicht 
        -A<br>
        </strong></em></font></div></td>
    <td bgcolor="#0099FF"><div align="center"><font size="1"><em><strong>G -</strong></em>Sp&auml;tschicht<em><strong>-A</strong></em></font></div></td>
  ...
  <form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    <tr onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><div align="left"><font size="1"><strong><img src="picture/b_newdb.png" width="16" height="16"><?php echo $row_rst2['paletten']; 
	
		
		?></strong></font></div></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1"><?php echo $row_rst2['bezeichnung']; ?></font></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><font size="1"><?php echo $row_rst2['nummer']; ?></font></td>
      <td    bgcolor="#EEEEEE" nowrap="nowrap"><div align="center"><font size="1"><?php echo $row_rst2['stueck']; ?></font></div></td>
      <td nowrap="nowrap"> 
        <font size="1"> 
        <select name="select">
          <option value="neu" <?php if (!(strcmp("neu", $row_rst2['mog1']))) {echo "SELECTED";} ?>>neu</option>
          <option value="1" <?php if (!(strcmp(1, $row_rst2['mog1']))) {echo "SELECTED";} ?>>1</option>
          <option value="2" <?php if (!(strcmp(2, $row_rst2['mog1']))) {echo "SELECTED";} ?>>2</option>
          <option value="3" <?php if (!(strcmp(3, $row_rst2['mog1']))) {echo "SELECTED";} ?>>4</option>
        </select>
        <select name="select2">
          <option value="neu" <?php if (!(strcmp("neu", $row_rst2['moa1']))) {echo "SELECTED";} ?>>neu</option>
          <option value="1" <?php if (!(strcmp(1, $row_rst2['moa1']))) {echo "SELECTED";} ?>>1</option>
          <option value="2" <?php if (!(strcmp(2, $row_rst2['moa1']))) {echo "SELECTED";} ?>>2</option>
          <option value="3" <?php if (!(strcmp(3, $row_rst2['moa1']))) {echo "SELECTED";} ?>>4</option>
        </select>
        </font></td>
...
.<img src="vl413.gantthourex1.php?datum=<?php echo $HTTP_POST_VARS['datum']; ?>"><br>
  ...
  <table width="645" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#CCCCFF" onmousedown="setPointer(this, 1, 'click', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseover="setPointer(this, 1, 'over', '#EEEEEE', '#CCCCFF', '#FFCC99');" onmouseout="setPointer(this, 1, 'out', '#EEEEEE', '#CCCCFF', '#FFCC99');"> 
      ...
      <td nowrap="nowrap"> <div align="right">
          <input name="htyp" type="hidden" id="htyp" value="6">
          <input name="hurl_user" type="hidden" id="hurl_user" value="<?php echo $url_user; ?>">
