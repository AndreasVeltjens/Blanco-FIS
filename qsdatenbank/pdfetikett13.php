...
$pdf->SetFont('Helvetica','',8);
	$pdf->Text(65,5,"EAN13");
		...
		$barcodepath="barcode/testbild.png";
	 	$pdf->Image($barcodepath,90,15,15,30,"","");
 ...
 */		/* $pdf->Text(65,5,"Serien-Nr."); */
		...
		$pdf->Text(2,20,$row_rst4['Nummer']);
		$pdf->SetFont('Helvetica','',8);
		$pdf->Text(2,24,"Einlagerung: ".date("d-m-Y",time() ));
		
/* alternativ Lagerplatzbezeichnung */	
		if($alternative==1){ 	
			$pdf->Text(2,27,"Lagerplatz: ".$row_rst4['lagerplatzalternative']); 
		}elseif($alternative==2){ 	
			$pdf->Text(2,27,"Lagerplatz: ".$row_rst4['lagerplatzalternative2']); 
		}else{		
			$pdf->Text(2,27,"Lagerplatz: ".$row_rst4['lagerplatz']);  
		}
	
		$pdf->Text(2,30,"Verpackungsgröße: ".$row_rst4['verpackung']); 
		$pdf->Text(2,33,"Wiederbeschaffungszeit: ".$row_rst4['wiederbeschaffungszeit']); 
		$pdf->Text(2,36,"Kontierung: ".$row_rst4['Kontierung']); 
		$pdf->Text(2,39,"Warengruppe: ".$row_rst4['Gruppe']); 
...
/* logo anzeigen */
		...
		$pdf->Image($materialbild,50,15,40,25,"","");
