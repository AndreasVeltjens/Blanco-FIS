...
$queryString_rst2 = sprintf("&totalRows_rst2=%d%s", $totalRows_rst2, $queryString_rst2);
 ...
 if ((isset($HTTP_POST_VARS["ansprechpartner"])) ) {
...
$updateGoTo = "la40.php?url_user=".$row_rst1['id']."&url_fmart=1";
  header(sprintf("Location: %s", $updateGoTo));
}
...
<form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="980" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="158">Aktionen W&auml;hlen: <img src="picture/b_drop.png" width="16" height="16"><input name="cancel" type="submit" id="cancel" value="Zur&uuml;ck"></td>
      <td width="238">  
	 
	  <input name="ansprechpartner" type="submit" id="ansprechpartner" value="Ansprechpartner anzeigen"></td>
      <td width="432"> <div align="right"> 
          <input name="hurl_user" type="hidden" id="hurl_user" value="<?php echo $row_rst1['id']; ?>">
          <img src="picture/b_newdb.png" width="16" height="16"> 
          <input name="new" type="submit" id="new" value="neue Fehlermeldung anlegen">
        </div></td>
    </tr>
...
<p>&nbsp;<a href="<?php printf("%s?pageNum_rst2=%d%s", $currentPage, 0, $queryString_rst2); ?>">First</a> 
  ...
  - Fehlermeldungen: <?php echo ($startRow_rst2 + 1) ?> bis <?php echo min($startRow_rst2 + $maxRows_rst2, $totalRows_rst2) ?><font size="2" face="Arial, Helvetica, sans-serif"> </font> </p>
<p>&nbsp;Statistik: <?php echo $totalRows_rst2 ?> Fehlermeldungen angelegt.</p>
<p>
<p>
  <?php
