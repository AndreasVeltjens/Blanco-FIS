...
include('picture/barcodeI25.php');
	...
	/* 	$pdf->SetFont('Helvetica','B',10);
		...
		$pdf->SetFont('Helvetica','',10);
		$pdf->Ln(5);
		$pdf->Write(12, 'Gerätetyp	            	: '.urldecode($row_rst3['Bezeichnung']."        "));
...
/* Lieferadresse begin */
		...
		$pdf->Write(13, 'Rücklieferung an   : '.utf8_decode(str_replace("\n"," - ",$row_rst1['lieferung'])));
		$pdf->Ln(4);
	...
	$pdf->Ln(4);
		...
		/* Ende alternative Rechnungsempänger */
		...
		$pdf->Ln(4);
		$pdf->Write(10, '                                                                                                                                                       Telefonnummer für Rückfragen:');
		$pdf->Ln(4);
	...
	if ($row_rst2['gvwl']==0){
		$pdf->MultiCell(10,3,"Bitte erteilen Sie uns innerhalb von 7 Tagen einen Reparaturauftrag und kreuzen Sie die gewünschte Variante an.",0,"","");
		$pdf->MultiCell(10,3,"Sollten Sie von unserem Reparaturangebot kein Gebrauch machen, bitten wir höfflich um Ihre Nachricht. Erhalten wir ",0,"","");
		$pdf->MultiCell(10,3,"nach 3 Wochen keine Nachricht von Ihnen, senden wir Ihr Gerät ohne Reparatur kostenpflichtig zurück.",0,"","");
