...
class PHPMailer
{
     ...
     * @var string
     */
    public $DKIM_identity = ''; //'callbackAction';
    /**
     * Used with DKIM DNS Resource Record
     * optional, in format of email address 'you@yourdomain.com'
     * @var string
    ...
    // CONSTANTS
    /////////////////////////////////////////////////
    private $sign_key_file = ""; // message only, continue processing
    private $sign_key_pass = ""; // message?, likely ok to continue processing
    private $exceptions = false; // message, plus full stop, critical error reached
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        $DKIMtime = time(); // Signature UNIX_TIMESTAMP = seconds since 00:00:00 - Jan 1, 1970 (UTC time zone)
...
class FisMailer
{
    ...
    {
        $this->SetFooter(utf8_encode(FIS_COMPANY . " " . FIS_COMPANY_SLOGAN));
    }
    ...
    {
        $this->mail['content'] = utf8_encode($data);
    }
    ...
    function SendifisMail()
    {
        if ($this->ValidateMail()) {
            ...
            $mail->SetFrom("info@uni-plan.de", $this->mail['name']);
