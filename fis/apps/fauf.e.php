...
$w = new ifisFauf($_REQUEST['faufid']);
    $_SESSION['last_faufid']=$_REQUEST['faufid'];
...
<html>
	<head>
		...
		<title>FIS Fertigungsauftrag</title>
					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Fertigungsauftrag bearbeiten</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="card-box table-responsive">
                                    ...
                                    <?php include('../apps/fauf.edit.php'); ?>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-sm-3">
                                <div class="card-box table-responsive">
                                    ...
                                    <hr>
                                    <?php if (($w->faufid)>0){ ?>
                                    <a href="print.faufid.php?sess=<?php echo $_REQUEST['sess']; ?>&faufid=<?php echo $w->faufid; ?>" target="_blank" class="btn btn-primary waves-effect waves-light"> <i class="zmdi zmdi-print"></i> Drucken </a>
                                    <hr>
                                    <?php } ?>
                                    <form method="post">
                                        Information über diesen Fertigungsauftrag per E-Mail an <?php echo $w->data['email']; ?> senden<br><br>
        ...
        <script type="text/javascript">
          function SetFaufTypeView(){
              ...
              if ($('#ftype').val() <1) {
                  ...
                  $('#agglomerat').hide();
                  $('#mahlgut').hide();
                  alert('Keine Fertigungsauftragsart gewählt. Typ:'+ $('#ftype').val() );
              }
          }
