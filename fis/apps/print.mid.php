...
define('PDF_HEADER_TITLE',"Prüfprotokoll");
define('PDF_HEADER_LFD',"$w->fid");
...
// QRCODE,H : QR-CODE Best error correction
    $pdf->write2DBarcode('http://www.albafis.de/index.php?bks='.$_SESSION['classifiedDirectoryID'].'&action=viewmeasure&item=' . $w->fid, 'QRCODE,H', 18, 20, PDF_QRCODE_SIZE, PDF_QRCODE_SIZE, $style, 'N');
} else {
//headertxt
...
$pdf->writeHTML(substr($w->data['fdatum'],0,16), false, false, false, false, '');

$pdf->SetAbsXY(BEZ_X,DATEN_Y+10);
$pdf->SetFont('helvetica', 'B', 12);
$pdf->writeHTML("Prüfgerät", false, false, false, false, '');

$pdf->SetAbsXY(DATEN_X,DATEN_Y+10);
$pdf->SetFont('helvetica', '', 12);
$pdf->writeHTML(GetListMidDevice("text",$w->data['mdevice'],$w->data['mtype']), false, false, false, false, '');

$pdf->SetAbsXY(DATEN_X,DATEN_Y+15);
$pdf->SetFont('helvetica', '', 12);
$pdf->writeHTML(GetListMidType("text",$w->data['mtype']), false, false, false, false, '');

$pdf->SetAbsXY(BEZ_X,DATEN_Y+25);
$pdf->SetFont('helvetica', 'B', 12);
$pdf->writeHTML("Ergebnis", false, false, false, false, '');

$pdf->SetAbsXY(DATEN_X,DATEN_Y+25);
$pdf->SetFont('helvetica', '', 12);
$pdf->writeHTML($w->data['mfi'], false, false, false, false, '');


$pdf->SetAbsXY(BEZ_X,DATEN_Y+35);
$pdf->SetFont('helvetica', 'B', 12);
$pdf->writeHTML("Daten", false, false, false, false, '');

$pdf->SetAbsXY(DATEN_X,DATEN_Y+35);
$pdf->SetFont('helvetica', '', 12);
$pdf->writeHTML($w->data['m1']." g", false, false, false, false, '');

$pdf->SetAbsXY(DATEN_X,DATEN_Y+40);
$pdf->SetFont('helvetica', '', 12);
$pdf->writeHTML($w->data['m2']." g", false, false, false, false, '');

$pdf->SetAbsXY(DATEN_X,DATEN_Y+45);
$pdf->SetFont('helvetica', '', 12);
$pdf->writeHTML($w->data['m3']." g", false, false, false, false, '');

$pdf->SetAbsXY(DATEN_X,DATEN_Y+50);
$pdf->SetFont('helvetica', '', 12);
$pdf->writeHTML($w->data['m4']." g", false, false, false, false, '');

$pdf->SetAbsXY(DATEN_X,DATEN_Y+55);
$pdf->SetFont('helvetica', '', 12);
$pdf->writeHTML($w->data['m5']." g", false, false, false, false, '');

$pdf->SetAbsXY(DATEN_X,DATEN_Y+60);
$pdf->SetFont('helvetica', '', 12);
$pdf->writeHTML($w->data['m6']." g", false, false, false, false, '');


$pdf->SetAbsXY(BEZ_X,DATEN_Y+70);
$pdf->SetFont('helvetica', 'B', 12);
$pdf->writeHTML("Prüfmethode", false, false, false, false, '');

$pdf->SetAbsXY(DATEN_X,DATEN_Y+70);
$pdf->SetFont('helvetica', '', 12);
$pdf->writeHTML(GetListMFIMethode("text",$w->data['mfimethode']), false, false, false, false, '');
...
$pdf->SetAbsXY(DATEN_X,DATEN_Y+80);
$pdf->SetFont('helvetica', '', 10);
