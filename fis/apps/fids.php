...
if (isset($_POST['new'])){
    ...
    if ($w->InsertData($_POST)){
        header ("Location: ../apps/fids.php?sess=".$_SESSION['sess']."");
        exit;
    }
}
$w=new ifisFid();
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.php?sess=<?php echo $_SESSION['sess'] ?>" class="logo">
                            <i class="zmdi zmdi-toys icon-c-logo"></i><span></span><span>PPS</span>
                ...
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="custom-width-modalLabel">Neue Rückmeldung anlegen</h4>
                        </div>

                        <?php include ("fid.edit.php");?>
					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Rückmeldungen</h4>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="gebindeID" class="col-sm-4 control-label">Gebinde ID</label>
                                            <div class="col-sm-7">
                                                <input  type="text" class="form-control" name="gebindeID" id="gebindeID" placeholder="Gebinde-ID eingeben" value="<?php echo $_SESSION['gebindeID']; ?>">
                                            </div>

                                        </div>
                                        <div class="form-group">
                                            <label for="gebindeID" class="col-sm-4 control-label">Materialbezeichung</label>
                                            <div class="col-sm-7">
                                        ...
                                        <a href="#custom-width-modal2" data-toggle="modal" data-target="#custom-width-modal2" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue Rückmeldung anlegen</a>
                                ...
                                <div class="card-box table-responsive">
                                    <div class="dropdown pull-right">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li class="divider"></li>
                                            <li><a href="#">Neue Rückmeldung</a></li>
                                        </ul>
                                    </div>

                                    <h4 class="header-title m-t-0 m-b-30">Rückmeldeliste</h4>
...
<?php if (!isset($_REQUEST['view'])) { ?>
                ajax:"fid.d.php?sess=<?php echo $_SESSION['sess']; ?>",
<?php } else { ?>
                ajax:"fid.d.php?sess=<?php echo $_SESSION['sess']; ?>&view=<?php echo $_REQUEST['view']; ?>",
<?php } ?>
                order: [[ 1, "desc" ]],
                "columnDefs": [
                    {
                        ...
                        "render": function (data, type, row) {
                            <?php if (!isset($_REQUEST['view'])) { ?>
                            return "<a href='../apps/fid.e.php?sess=<?php echo $_SESSION['sess']; ?>&fid=" + row[0] + "'> <i class='zmdi zmdi-edit'> </i> " + row[1] + " </a>";
                            <?php } else { ?>
                            return "<a href='../apps/fid.e.php?sess=<?php echo $_SESSION['sess']; ?>&view=<?php echo $_REQUEST['view']; ?>&fid=" + row[0] + "'> <i class='zmdi zmdi-edit'> </i> " + row[1] + " </a>";
                            <?php } ?>
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) {
<?php if (!isset($_REQUEST['view'])) { ?>
                            return "<a href='../apps/fid.e.php?sess=<?php echo $_SESSION['sess']; ?>&fid=" + row[0] + "'> <i class='zmdi zmdi-edit'> </i> " + row[10] + " </a>";
<?php } else { ?>
                            return "<a href='../apps/fid.e.php?sess=<?php echo $_SESSION['sess']; ?>&view=<?php echo $_REQUEST['view']; ?>&fid=" + row[0] + "'> <i class='zmdi zmdi-edit'> </i> " + row[12] + " </a>";
 <?php } ?>
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row ) {
<?php if (!isset($_REQUEST['view'])) { ?>
                        return "<a href='../apps/print.fid.php?sess=<?php echo $_SESSION['sess']; ?>&fid=" + row[0]+"' target='_blank'> <i class='zmdi zmdi-print'> </i> " + row[9]+"</a>";
<?php } else { ?>
                            return "<a href='../apps/fid.e.php?sess=<?php echo $_SESSION['sess']; ?>&view=<?php echo $_REQUEST['view']; ?>&fid=" + row[0] + "'> <i class='zmdi zmdi-edit'> </i> " + row[11] + " </a>";
<?php } ?>
