...
$w = new ifisWareneingang($_REQUEST['wid']);
    $_SESSION['last_wid']=$_REQUEST['wid'];
...
if (isset ($_POST['sendemail'])){
    ...
    if (!isset($_POST['subject'])){$_POST['subject']=utf8_decode("Wareneingang ALBA RECYCLING - Werk Eisenhüttenstadt");}
					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Wareneingang bearbeiten</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="card-box table-responsive">
                                    ...
                                    <?php include('../apps/wareneingang.edit.php'); ?>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-sm-3">
                                <div class="card-box table-responsive">
                                    ...
                                    <a href="wareneingang.php?sess=<?php echo $_REQUEST['sess']; ?>"><i class="zmdi zmdi-arrow-back"></i> Wareneingangsliste</a>
                                    <hr>
                                    <?php if (($w->wid)>0){ ?>
                                    <a href="print.wid.php?sess=<?php echo $_REQUEST['sess']; ?>&wid=<?php echo $w->wid; ?>" target="_blank" class="btn btn-primary waves-effect waves-light"> <i class="zmdi zmdi-print"></i> Drucken </a>
                                    <hr>
                                    <?php } ?>
                                    <form method="post">
                                        Information über diesen Wareneingang per E-Mail an <?php echo $w->data['email']; ?> senden<br><br>
