...
if (isset($_POST['new'])){
    ...
    if ($w->InsertData($_POST)){
        header ("Location: ../apps/kundendaten.php?sess=".$_SESSION['sess']."");
        exit;
    }
}
$w=new ifisCustomer();
	...
	<body class="fixed-left">
                ...
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="custom-width-modalLabel">Neuen Kunden anlegen</h4>
                        </div>
					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Kundendaten</h4>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="#custom-width-modal6" data-toggle="modal" data-target="#custom-width-modal6" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neuer Kunde</a>
                                ...
                                <div class="card-box table-responsive">
                                    <div class="dropdown pull-right">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li class="divider"></li>
                                            <li><a href="#">Neues Kundendatenblatt</a></li>
                                        </ul>
                                    </div>

                                    <h4 class="header-title m-t-0 m-b-30">Kundenliste</h4>
        ...
        <script >
            ...
            var table  = $("#datatable-buttons").DataTable({
                ajax:"customer.d.php?sess=<?php echo $_SESSION['sess']; ?>",
                order: [[ 1, "desc" ]],
                "columnDefs": [
                    {
                        "targets": -1,
                        ...
                        "render": function (data, type, row) {
                            return "<a href='../apps/kundendaten.e.php?sess=<?php echo $_SESSION['sess']; ?>&customerid=" + row[0] + "'> <i class='zmdi zmdi-edit'> </i>" + row[9] + "</a>";
                        }
                    },
                    {
                        "targets": -2,
                        "data": null,
                        "render": function ( data, type, row ) {
                        return "<a href='../apps/print.customerid.php?sess=<?php echo $_SESSION['sess']; ?>&customerid=" + row[0]+"' target='_blank'> <i class='zmdi zmdi-print'> </i> " + row[8]+"</a>";
                    }
                    }
                ],
                language: {
