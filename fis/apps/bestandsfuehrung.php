					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Bestandsführung</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card-box table-responsive">
                                    <h4 class="page-title">Lagerbestand</h4>

                                    <?php
                                    echo $p->ShowAllFidDataByMaterial(8);
                                    ?>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box table-responsive">
                                    <h4 class="page-title">Gesamt-produzierte Menge</h4>

                                    <?php
                                    echo $p->ShowAllFidDataByMaterial(0);
                                    ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card-box table-responsive">
                                    <h4 class="page-title">Inventurbestand</h4>

                                    <?php
                                    echo $p->ShowAllFidDataByMaterial(999);
                                    ?>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box table-responsive">
                                    <h4 class="page-title">Sperrbestand</h4>

                                    <?php
                                    echo $p->ShowAllFidDataByMaterial(7);
                                    ?>
