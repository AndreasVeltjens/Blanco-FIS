...
if (isset($_POST['new'])){
    $w=new ifisWareneingang();
    if ($w->InsertData($_POST)){
        header ("Location: ../apps/wareneingang.php?sess=".$_SESSION['sess']."");
        exit;
    }
}
$wa = new ifisAllwarenausgang();
$ws = new ifisAllwareneingang();
AddSessionMessage("info","Wareneingangübersicht aktualisiert.","Benachrichtigung");
	...
	<body class="fixed-left">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.php?sess=<?php echo $_SESSION['sess'] ?>" class="logo">
                            <i class="zmdi zmdi-toys icon-c-logo"></i><span></span><span>WaWi</span>
                ...
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="custom-width-modalLabel">Neuen Wareneingang anlegen</h4>
                        </div>

                        <?php include ("wareneingang.edit.php");?>
					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Wareneingang</h4>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="#custom-width-modal2" data-toggle="modal" data-target="#custom-width-modal2" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neuer Wareneingang</a>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <div class="dropdown pull-right">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="#">Neue Umlagerung</a></li>

                                            <li class="divider"></li>
                                            <li><a href="#">Neuer Wareneingang</a></li>
                                        </ul>
                                    </div>

                                    <h4 class="header-title m-t-0 m-b-30">Wareneingangsliste</h4>
        ...
        <script >
            ...
            var table  = $("#datatable-buttons").DataTable({
                ajax:"datatable.php?sess=<?php echo $_SESSION['sess']; ?>",
                order: [[ 1, "desc" ]],
                "columnDefs": [
                    {
                        "targets": -1,
                        ...
                        "render": function (data, type, row) {
                            return "<a href='../apps/wareneingang.e.php?sess=<?php echo $_SESSION['sess']; ?>&wid=" + row[0] + "'>" + row[6] + "</a>";
                        }
                    },
                    {
                        "targets": -2,
                        "data": null,
                        "render": function ( data, type, row ) {
                        return "<a href='../apps/print.wid.php?sess=<?php echo $_SESSION['sess']; ?>&wid=" + row[0]+"' target='_blank'> <i class='zmdi zmdi-print'> </i> " + row[5]+"</a>";
                    }
                    }
                ],
                language: {
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#filer_input1").filer({
                        ...
                        uploadFile: {
                            url: "../apps/upload.php?userid=<?php echo $u->userid; ?>&path=wareneingang",
                            data: null,
                            type: 'POST',
                    ...
                    var file = file.name;
                    $.post('../apps/remove_file.php?userid=<?php echo $u->userid; ?>&path=wareneingang', {file: file});
                },
                onEmpty: null,
                    options: null,
                    captions: {
