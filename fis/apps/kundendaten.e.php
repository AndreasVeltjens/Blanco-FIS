...
$w = new ifisCustomer($_REQUEST['customerid']);
$_SESSION['last_customerid']=$_REQUEST['customerid'];
					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Kundendaten bearbeiten</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="card-box table-responsive">
                                    ...
                                    <?php include('../apps/customer.edit.php'); ?>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-sm-3">
                                <div class="card-box table-responsive">
                                    ...
                                    <a href="kundendaten.php?sess=<?php echo $_REQUEST['sess']; ?>"><i class="zmdi zmdi-arrow-back"></i> Kundenliste</a>
                                    <hr>

                                    <form method="post">
                                        Information über diese Kundendaten per E-Mail an <?php echo $w->data['email']; ?> senden<br><br>
