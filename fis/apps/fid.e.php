...
if (isset ($_POST['edit'])){
   $w->SaveData($_POST);
    if (isset($_REQUEST['view'])){
        header("Location: ../apps/fids.php?sess=" . $_SESSION['sess'] . "&view=qs");
    }else {
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.php?sess=<?php echo $_SESSION['sess'] ?>" class="logo">
                            <i class="zmdi zmdi-toys icon-c-logo"></i><span><span>PPS</span></span>
					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Rückmeldung bearbeiten</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="card-box table-responsive">
                                    ...
                                    <a href="fids.php?sess=<?php echo $_REQUEST['sess']; ?>"><i class="zmdi zmdi-arrow-back"></i> Rückmeldungen anzeigen</a>

                                    <hr>
                                    <a href="fids.php?sess=<?php echo $_REQUEST['sess']; ?>&view=qs"><i class="zmdi zmdi-arrow-back"></i> QS- Prüfbestand anzeigen</a>

                                    <hr>
                                    <a href="fauf.php?sess=<?php echo $_REQUEST['sess']; ?>"><i class="zmdi zmdi-arrow-back"></i> Fertigungsauftragsliste</a>
                                    <hr>
                                    <?php if (($w->fid)>0){ ?>
                                    <a href="print.fid.php?sess=<?php echo $_REQUEST['sess']; ?>&fid=<?php echo $w->fid; ?>" target="_blank" class="btn btn-primary waves-effect waves-light"> <i class="zmdi zmdi-print"></i> Drucken </a>
                                    <hr>
                                    <?php } ?>
                                    <form method="post">
                                        Information über diese Rückmeldung per E-Mail an <?php echo $w->data['email']; ?> senden<br><br>
