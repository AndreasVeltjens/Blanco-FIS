...
<html>
	<head>
		<meta charset="utf-8">
        <meta http-equiv="refresh" content="3; URL=./index.php?sess=<?php echo $_SESSION['sess']; ?>">
...
<body>
    <div class="text-center logo-alt-box">
        <a href="../index.php" class="logo"><span>FIS<span>12</span></span></a>
    ...
    <div class="wrapper-page">
        ...
        <div class="m-t-30 card-box">
            <div class="text-center">
                <h4 class="text-uppercase font-bold m-b-0">Welcome Back <?php echo $us->GetUsername() ?></h4>
