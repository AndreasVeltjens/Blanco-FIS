...
$_SESSION['last_fid']=$_REQUEST['fid'];


if (isset ($_POST['edit'])){
   $w->SaveData($_POST);
    if (isset($_REQUEST['view'])){
        header("Location: ../apps/mfr.e.php?sess=" . $_SESSION['sess'] . "&view=qs&fid=".$_SESSION['last_fid']);
    }else {
        header("Location: ../apps/mfr.e.php?sess=" . $_SESSION['sess'] . "&fid=".$_SESSION['last_fid']);
    }
    exit;
...
if (isset ($_POST['copy'])){
    $w->InsertData($_POST);
    if (isset($_REQUEST['view'])){
        header("Location: ../apps/mfrs.php?sess=" . $_SESSION['sess'] . "&view=qs");
    }else {
        header("Location: ../apps/mfrs.php?sess=" . $_SESSION['sess'] . "");
    }
    exit;
}
                            ...
                            <div class="col-sm-12">
                                <div class="btn-group pull-right m-t-5 m-b-20">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="mfrs.php?sess=<?php echo $_REQUEST['sess']; ?>">Neue Messung anlegen</a></li>

                                        <li class="divider"></li>
                                        <li><a href="#">Separated link</a></li>
                                    </ul>
                                </div>
                                <h4 class="page-title">Messung bearbeiten</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="card-box table-responsive">
                                    ...
                                    <a href="mfrs.php?sess=<?php echo $_REQUEST['sess']; ?>"><i class="zmdi zmdi-arrow-back"></i> alle Messungen anzeigen</a>
                                    <hr>

                                    <?php if (($w->fid)>0){ ?>
                                    <a href="print.mid.php?sess=<?php echo $_REQUEST['sess']; ?>&fid=<?php echo $w->fid; ?>" target="_blank" class="btn btn-primary waves-effect waves-light"> <i class="zmdi zmdi-print"></i> Drucken </a>
                                    <hr>
                                    <?php } ?>
                                ...
                                <div class="card-box table-responsive">
                                    <h4 class="page-title">Prüfergebnis</h4>
                                    <?php if ($w->data['mtype']==1){ ?>

                                    <h4>
                                    <?php echo $w->GetMFI(); ?>
                                    </h4>
                                    Prüfzeit:  <?php echo $w->GetMFITime(); ?> s <hr>
                                    Genauigkeit: <br><?php echo $w->GetMFIOffset(); ?><hr>
                                    Anzahl der Messwerte: <br><?php echo $w->CheckMFIMeasure(); ?><hr>
                                        Durchschnittsmasse: <br><?php echo $w->CalulateDurchschnittsprobe(); ?>
                                    ...
                                    <?php if ($w->data['mtype']==6){ ?>
                                        <h4>
                                            <?php echo $w->CalculateCSB(); ?>
                                        </h4>
                                    <?php } ?>
                                    <?php if ($w->data['mtype']==5){ ?>
                                        <h4>
                                            <?php echo $w->CalculateSchuettdichte(); ?>
                                        </h4>
                                    <?php } ?>
                                </div>
