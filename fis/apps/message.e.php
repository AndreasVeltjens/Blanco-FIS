...
$w = new ifisMessageid($_REQUEST['fid']);
$_SESSION['last_messageid']=$_REQUEST['fid'];


if (isset ($_POST['edit'])){
   $w->SaveData($_POST);
    if (isset($_REQUEST['view'])){
        header("Location: ../apps/message.e.php?sess=" . $_SESSION['sess'] . "&view=qs&fid=".$_SESSION['last_messageid']);
    }else {
        header("Location: ../apps/message.e.php?sess=" . $_SESSION['sess'] . "&fid=".$_SESSION['last_messageid']);
    }
    exit;
...
if (isset ($_POST['copy'])){
    $w->InsertData($_POST);
    if (isset($_REQUEST['view'])){
        header("Location: ../apps/messages.php?sess=" . $_SESSION['sess'] . "&view=qs");
    }else {
        header("Location: ../apps/messages.php?sess=" . $_SESSION['sess'] . "");
    }
    exit;
}
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.php?sess=<?php echo $_SESSION['sess'] ?>" class="logo">
                            <i class="zmdi zmdi-toys icon-c-logo"></i><span><span>ASA</span></span>
                            ...
                            <div class="col-sm-12">
                                <div class="btn-group pull-right m-t-5 m-b-20">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="mfrs.php?sess=<?php echo $_REQUEST['sess']; ?>">Neue Meldung anlegen</a></li>

                                        <li class="divider"></li>
                                        <li><a href="#">Separated link</a></li>
                                    </ul>
                                </div>
                                <h4 class="page-title">Meldung bearbeiten</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="card-box table-responsive">
                                    ...
                                    <?php include('../apps/message.edit.php'); ?>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-sm-3">
                                <div class="card-box table-responsive">
                                    ...
                                    <a href="messages.php?sess=<?php echo $_REQUEST['sess']; ?>"><i class="zmdi zmdi-arrow-back"></i> alle Meldungen anzeigen</a>
                                    <hr>

                                    <?php if (($w->fid)>0){ ?>
                                    <a href="print.messageid.php?sess=<?php echo $_REQUEST['sess']; ?>&fid=<?php echo $w->fid; ?>" target="_blank" class="btn btn-primary waves-effect waves-light"> <i class="zmdi zmdi-print"></i> Drucken </a>
                                    <hr>
                                    <?php } ?>
