                        ...
                        <div class="row">
                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <form method="post">
                                        <div class="form-group">
                                            <label for="notes" class="col-sm-4 control-label">Problembeschreibung*</label>
                                            <div class="col-sm-7">
                                                <textarea name="notes" id="notes" type="text" rows='13' placeholder="Geben Sie hier Ihre Problembeschreibung ein..." required class="form-control" ></textarea>
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="card-box table-responsive">
                                    ...
                                    Senden Sie eine E-Mail, wenn Programmfehler auftreten.
                                </div>
                            </div><!-- end col -->
