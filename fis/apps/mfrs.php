...
if (isset($_POST['new'])){
    ...
    if ($w->InsertData($_POST)){
        header ("Location: ../apps/mfr.e.php?sess=".$_SESSION['sess']."&fid=".$_SESSION['mid']);
        exit;
    }
}
$w=new ifisFid();
...
<html>
	<head>
		...
		<title>Werkstoffprüfungen</title>
        <!-- Jquery filer css -->
	...
	<body class="fixed-left">
		...
		<div id="wrapper">
                ...
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="custom-width-modalLabel">Neue MFR</h4>
                        </div>

                        <?php
                        $w->data['mtype']=1;
                        include ("mfr.edit.php");?>
            ...
            <div id="custom-width-modal4" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="custom-width-modalLabel">Neu Restfeuchte</h4>
                        </div>
            ...
            <div id="custom-width-modal5" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="custom-width-modalLabel">Neue Schlammprobe</h4>
                        </div>
            ...
            <div id="custom-width-modal6" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="custom-width-modalLabel">Neue Trennung</h4>
                        </div>
            ...
            <div id="custom-width-modal7" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="custom-width-modalLabel">Neue Schüttdichte</h4>
                        </div>
            ...
            <div id="custom-width-modal8" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="custom-width-modalLabel">Neue CSB</h4>
                        </div>
					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Messungen</h4>
                            </div>
                        </div>
                        <form method="post">
                        <div class="row">
...
<hr>
                                        <a href="#custom-width-modal3" data-toggle="modal" data-target="#custom-width-modal3" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue MFR-Messung</a>
                                        <a href="#custom-width-modal4" data-toggle="modal" data-target="#custom-width-modal4" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue Restfeuchte</a>
                                        <a href="#custom-width-modal5" data-toggle="modal" data-target="#custom-width-modal5" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue Schlammprobe</a>
                                        <a href="#custom-width-modal6" data-toggle="modal" data-target="#custom-width-modal6" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue Trennung Becken</a>
                                        <a href="#custom-width-modal7" data-toggle="modal" data-target="#custom-width-modal7" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue Schüttdichte</a>
                                        <a href="#custom-width-modal8" data-toggle="modal" data-target="#custom-width-modal8" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue CSB</a>
                                ...
                                <div class="card-box table-responsive">
                                    <div class="dropdown pull-right">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li class="divider"></li>
                                            <li><a href="#">Neue Messung</a></li>
                                        </ul>
                                    </div>

                                    <h4 class="header-title m-t-0 m-b-30">Messwertliste</h4>
...
<?php if (!isset($_REQUEST['view'])) { ?>
                ajax:"mfr.d.php?sess=<?php echo $_SESSION['sess']; ?>",
<?php } else { ?>
                ajax:"mfr.d.php?sess=<?php echo $_SESSION['sess']; ?>&view=<?php echo $_REQUEST['view']; ?>",
<?php } ?>
                order: [[ 1, "desc" ]],
                "columnDefs": [
                    {
                        ...
                        "render": function (data, type, row) {
                            <?php if (!isset($_REQUEST['view'])) { ?>
                            return "<a href='../apps/mfr.e.php?sess=<?php echo $_SESSION['sess']; ?>&fid=" + row[0] + "'> <i class='zmdi zmdi-edit'> </i> " + row[11] + "  "+ row[0] +"</a>";
                            <?php } else { ?>
                            return "<a href='../apps/mfr.e.php?sess=<?php echo $_SESSION['sess']; ?>&view=<?php echo $_REQUEST['view']; ?>&fid=" + row[11] + "'> <i class='zmdi zmdi-edit'> </i> " + row[1] + " </a>";
                            <?php } ?>
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) {
<?php if (!isset($_REQUEST['view'])) { ?>
                            return "<a href='../apps/mfr.e.php?sess=<?php echo $_SESSION['sess']; ?>&fid=" + row[0] + "'> <i class='zmdi zmdi-edit'> </i> " + row[10] +" </a>";
<?php } else { ?>
                            return "<a href='../apps/mfr.e.php?sess=<?php echo $_SESSION['sess']; ?>&view=<?php echo $_REQUEST['view']; ?>&fid=" + row[0] + "'> <i class='zmdi zmdi-edit'> </i> " + row[12] + " </a>";
 <?php } ?>
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row ) {
<?php if (!isset($_REQUEST['view'])) { ?>
                        return "<a href='../apps/print.mid.php?sess=<?php echo $_SESSION['sess']; ?>&fid=" + row[0]+"' target='_blank'> <i class='zmdi zmdi-print'> </i> " + row[9]+"</a>";
<?php } else { ?>
                            return "<a href='../apps/mfr.e.php?sess=<?php echo $_SESSION['sess']; ?>&view=<?php echo $_REQUEST['view']; ?>&fid=" + row[0] + "'> <i class='zmdi zmdi-edit'> </i> " + row[11] + " </a>";
<?php } ?>
