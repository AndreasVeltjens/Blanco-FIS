...
if (isset($_REQUEST['Smessagetype'])) {$_SESSION['Smessagetype']=$_REQUEST['Smessagetype'];}
...
if (isset($_POST['refresh'])) {
    ...
    $_SESSION['Smessagetype'] = $_POST['Smessagetype'];
}
...
if (isset($_POST['new'])){
    ...
    if ($w->InsertData($_POST)){
        header ("Location: ../apps/message.e.php?sess=".$_SESSION['sess']."&fid=".$_SESSION['mid']);
        exit;
    }
}
$w=new ifisFid();
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.php?sess=<?php echo $_SESSION['sess'] ?>" class="logo">
                            <i class="zmdi zmdi-toys icon-c-logo"></i><span></span><span>ASA</span>
...
<?php if ($_SESSION['Smessagetype']==1) { ?>
                ...
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="custom-width-modalLabel">Unfallmeldung</h4>
                        </div>

                        <?php
                        $w->data['mtype']=1;
                        include ("message.edit.php");?>
...
<?php } ?>
<?php if ($_SESSION['Smessagetype']==2) { ?>
            <div id="custom-width-modal4" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="custom-width-modalLabel">Schadenmeldung</h4>
                        </div>
...
<?php } ?>
<?php if ($_SESSION['Smessagetype']==3) { ?>
            <div id="custom-width-modal5" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog" style="width:55%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="custom-width-modalLabel">Fremdfirmenanmeldung</h4>
                        </div>
...
<?php } ?>
            ...
            <?php if ($_SESSION['Smessagetype']==4) { ?>
                <div id="custom-width-modal6" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog" style="width:55%;">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h4 class="modal-title" id="custom-width-modalLabel">Erlaubnisschein</h4>
                            </div>
            ...
            <?php } ?>
            <?php if ($_SESSION['Smessagetype']==5) { ?>
                <div id="custom-width-modal7" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog" style="width:55%;">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h4 class="modal-title" id="custom-width-modalLabel">Besucheranmeldung</h4>
                            </div>
					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title"><?php echo GetListMessageType('text',$_SESSION['Smessagetype']); ?> </h4>
                            </div>
                        </div>
                        <form method="post">
                        <div class="row">
...
<br><br>
                                    ...
                                    <div class="form-group">
                                        <label for="Smessagetype" class="col-sm-4 control-label">Meldungsart</label>
                                        <div class="col-sm-8">
                                            <select  class="form-control select2" name="Smessagetype" id="Smessagetype">
                                                <?php echo GetListMessageType("select",$_SESSION['Smessagetype']); ?>
                                            </select>
                                        </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    $str=$x->GetLastTimeOfMessage($_SESSION['Smessagetype']);
                                    $messages= new ifisAllMessageid();
                                    ?>
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        ...
                                        <div data-plugin="circliful" class="circliful-chart" data-dimension="200"
                                             data-text="<?php echo $str['prozent']?>%" data-info="des Jahres <?php echo $str['txt'] ?>" data-width="30" data-fontsize="24"
                                    ...
                                    <table id="table-anmeldungen" class="table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <?php echo $messages->GetList(3); ?>
                                    </table>

                                    <?php } ?>
                                    <?php if ($_SESSION['Smessagetype']==4) { ?>
                                    <div>Liste der Erlaubnisscheine</div>
                                    <table id="table-erlaubnis" class="table table-striped" cellspacing="0" width="100%">
                                        <thead>
                                        <tr>
                                            <th>Anmeldung-Nr.</th>
                                            <th>Datum</th>
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        ...
                                        <h3>
                                            <?php
                                            echo "Seit " . $str['days'] . " Tagen " . $str['hours'] . " Stunden und " . $str['minuten'] . " Minuten " . $str['txt'] . " ";
                                            }
                                            ?>
                                        ...
                                        <?php if ($_SESSION['Smessagetype']==1) { ?>
                                            <a href="#custom-width-modal3" data-toggle="modal" data-target="#custom-width-modal3" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue Unfallmeldung</a>
                                        <?php } ?>
                                        <?php if ($_SESSION['Smessagetype']==2) { ?>
                                            <a href="#custom-width-modal4" data-toggle="modal" data-target="#custom-width-modal4" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue Schadenmeldung</a>
                                        <?php } ?>
                                        <?php if ($_SESSION['Smessagetype']==3) { ?>
                                            <a href="#custom-width-modal5" data-toggle="modal" data-target="#custom-width-modal5" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue Fremdfirmenanmeldung</a>
                                        <?php } ?>
                                        <?php if ($_SESSION['Smessagetype']==4) { ?>
                                            <a href="#custom-width-modal6" data-toggle="modal" data-target="#custom-width-modal6" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neuer Erlaubnisschein</a>
                                        <?php } ?>
                                        <?php if ($_SESSION['Smessagetype']==5) { ?>
                                            <a href="#custom-width-modal7" data-toggle="modal" data-target="#custom-width-modal7" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-plus"></i> Neue Besucheranmeldung</a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-box table-responsive">
                                    <div class="dropdown pull-right">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li class="divider"></li>
                                            <li><a href="#">Neue Meldung</a></li>
                                        </ul>
                                    </div>

                                    <h4 class="header-title m-t-0 m-b-30">Meldungsliste</h4>
