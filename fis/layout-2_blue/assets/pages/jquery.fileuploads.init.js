...
$(document).ready(function(){
    ...
    $("#filer_input1").filer({
        ...
        uploadFile: {
            url: "../layout-2_blue/assets/plugins/jquery.filer/php/upload.php",
            data: null,
            type: 'POST',
		...
		files: [
			{
				...
				size: 145,
				type: "image/jpg",
				file: "../layout-2_blue/assets/images/thumbnail/1.jpg"
			},
			{
				name: "2.jpg",
				size: 145,
				type: "image/jpg",
				file: "../layout-2_blue/assets/images/thumbnail/2.jpg"
			}
		],
        addMore: false,
        clipBoardPaste: true,
        ...
        onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
            var file = file.name;
            $.post('../layout-2_blue/assets/plugins/jquery.filer/php/remove_file.php', {file: file});
        },
        onEmpty: null,
        options: null,
        captions: {
